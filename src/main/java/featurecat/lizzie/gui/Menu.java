...
public class Menu extends JMenuBar {
    ...
    public Menu() {
        ...
        JFontLabel lblCustomMode2 =
                new JFontLabel(
                        resourceBundle.getString("Menu.customLayout")
                                ...
                                + (Lizzie.config.isChinese ? "" : " ")
                                + "(Alt+9)");
        setToolTipJMenu(customeMode2, lblCustomMode2);
        JFontButton btnSetCustomMode2 =
                new JFontButton(resourceBundle.getString("Menu.customLayoutSet"));
        setTooltip(btnSetCustomMode2);
        ...
        final JFontCheckBoxMenuItem pureEstimateByTransparentSmall =
                new JFontCheckBoxMenuItem(resourceBundle.getString("Menu.kataEstimateByTransparentSmall"));
        kataEstimateInPureNet.add(pureEstimateByTransparentSmall);
        pureEstimateByTransparentSmall.addActionListener(
                new ActionListener() {
                    @Override
                    public void actionPerformed(ActionEvent e) {
        ...
        viewMenu.addMenuListener(
                new MenuListener() {
                    public void menuSelected(MenuEvent e) {
                        ...
                        if (Lizzie.config.showKataGoEstimateSmall) {
                            kataEstimateByTransparentSmall.setSelected(true);
                            kataEstimateByTransparentNotOnLive.setSelected(false);
                            kataEstimateByTransparent.setState(false);
                        } else {
                            kataEstimateByTransparentSmall.setSelected(false);
                        ...
                        if (Lizzie.config.showPureEstimateSmall) {
                            pureEstimateByTransparentSmall.setSelected(true);
                            pureEstimateByTransparentNotOnLive.setState(false);
                            pureEstimateByTransparent.setState(false);
                        } else {
                            pureEstimateByTransparentSmall.setSelected(false);
                ...
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
                        ...
                        for (int i = 0; i < engine.length; i++) {
                            changeEngineIcon(i, 0);
                        }
                        changeEngineIcon(Lizzie.leelaz.currentEngineN(), 3);
                    }
                });
    ...
    private void setToolTipJCheckMenu(JCheckBoxMenuItem menu, JFontLabel label) {
        if (Lizzie.config.isChinese) return;
        menu.setToolTipText(label.getText());
    }

    private void setTooltip(JCheckBoxMenuItem menu) {
        if (Lizzie.config.isChinese) return;
        menu.setToolTipText(menu.getText());
    }

    private void setToolTipJMenu(JMenuItem menu, JFontLabel label) {
        if (Lizzie.config.isChinese) return;
        menu.setToolTipText(label.getText());
    }

    private void setTooltip(JButton button) {
        if (Lizzie.config.isChinese) return;
    ...
    private void addRankMarkMenu(JPopupMenu rankPopupMenu, JMenu rankJMenu) {
        ...
        setToolTipJCheckMenu(rankCustomMove, lblCustomMove);
        if (Lizzie.config.isChinese) {
            ...
            chkShowBlack.addActionListener(
                    new ActionListener() {
                        ...
                        public void actionPerformed(ActionEvent e) {
                            ...
                            //推荐点上方功能选择存储于历史dongxiaoming
                            Lizzie.config.showBlackCandidatesHistroy=chkShowBlack.isSelected();
                            Lizzie.frame.refresh();
                        }
                    });
        }
            ...
            chkShowWhite.addActionListener(
                    new ActionListener() {
                        ...
                        public void actionPerformed(ActionEvent e) {
                            ...
                            //推荐点上方功能选择存储于历史dongxiaoming
                            Lizzie.config.showWhiteCandidatesHistroy=chkShowWhite.isSelected();
                            Lizzie.frame.refresh();
                        }
                    });
        }
                ...
                new Runnable() {
                    public void run() {
                        ...
                        if (EngineManager.currentEngineNo <= 20) {
                            if (engine[
                                    index == 1 ? EngineManager.currentEngineNo : EngineManager.currentEngineNo2]
                                    .getIcon()
                                    == null) {
                            } else {
