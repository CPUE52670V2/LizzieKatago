...
public class WinrateGraph {
    ...
    public void draw(Graphics2D g, Graphics2D gBlunder, Graphics2D gBackground, int posx, int posy, int width, int height) {
        ...
        final Paint gradient = new GradientPaint(new Point2D.Float(posx, posy), new Color(120, 120, 120, 180), new Point2D.Float(posx, posy + halfHeight), new Color(155, 155, 155, 185));
        final Paint gradient2 = new GradientPaint(new Point2D.Float(posx, posy + halfHeight), new Color(155, 155, 155, 185), new Point2D.Float(posx, posy + height), new Color(120, 120, 120, 180));
        ...
        if (!Lizzie.config.showBlunderBar && width >= 150) {
            ...
            if (numMoves <= 63) {
                for (int i = 1; i <= (numMoves / 10); i++)
                    if (numMoves - i * 10 > 3)
                        gBackground.drawString(String.valueOf(i * 10), posx + (i * 10 - 1) * width / numMoves - 3, posy + height - strokeRadius);
            } else if (numMoves <= 125) {
                for (int i = 1; i <= (numMoves / 20); i++)
                    if (numMoves - i * 20 > 3)
                        gBackground.drawString(String.valueOf(i * 20), posx + (i * 20 - 1) * width / numMoves - 3, posy + height - strokeRadius);
            } else if (numMoves < 205) {
                for (int i = 1; i <= (numMoves / 30); i++)
                    if (numMoves - i * 30 > 3)
                        gBackground.drawString(String.valueOf(i * 30), posx + (i * 30 - 1) * width / numMoves - 3, posy + height - strokeRadius);
            } else {
                for (int i = 1; i <= (numMoves / 40); i++)
                    if (numMoves - i * 40 > 3)
                        gBackground.drawString(String.valueOf(i * 40), posx + (i * 40 - 1) * width / numMoves - 3, posy + height - strokeRadius);
            }
        }
        double cwr = -1;
        int cmovenum = -1;
        ...
        if (EngineManager.isEngineGame || Lizzie.board.isPkBoard) {
            ...
            int x = posx + ((Lizzie.board.getHistory().getCurrentHistoryNode().getData().moveNumber - 1) * width / numMoves);
            g.setStroke(dashed);
            ...
            String moveNumString = String.valueOf(Lizzie.board.getHistory().getCurrentHistoryNode().getData().moveNumber);
            ...
            if (Lizzie.board.getHistory().getCurrentHistoryNode() != Lizzie.board.getHistory().getEnd()) {
                ...
                if (moveNum < 10)
                    g.drawString(moveNumString, moveNum < numMoves / 2 ? x + 3 : x - 10, posy + height - margin);
                else if (Lizzie.board.getHistory().getCurrentHistoryNode().getData().moveNumber > 99)
                    g.drawString(moveNumString, moveNum < numMoves / 2 ? x + 3 : x - 22, posy + height - margin);
                else g.drawString(moveNumString, moveNum < numMoves / 2 ? x + 3 : x - 16, posy + height - margin);
            }
            while (node.previous().isPresent() && node.previous().get().previous().isPresent()) {
                ...
                if (Lizzie.config.showBlunderBar) {
                    ...
                    int rectWidth = Math.max(Lizzie.config.minimumBlunderBarWidth, (int) (movenum * width / numMoves) - (int) ((movenum - 1) * width / numMoves));
                    gBlunder.fillRect(posx + (int) ((movenum - 1) * width / numMoves), blunderBottom - lastHeight, rectWidth, lastHeight);
                }
                if (node.getData().blackToPlay) {
                    g.setColor(Color.BLACK);
                    g.drawLine(posx + ((movenum - 2) * width / numMoves), posy + height - (int) (lastWr * height / 100), posx + (movenum * width / numMoves), posy + height - (int) (wr * height / 100));
                ...
                if (curMove.previous().isPresent() && movenum > 1) {
                    if (node == curMove) {
                        ...
                        if (node.getData().blackToPlay) {
                            ...
                            if (wr > 50) {
                                if (wr > 90) {
                                    g.drawString(wrString, xPos, posy + (height - (int) (wr * height / 100)) + 6 * DOT_RADIUS);
                                } else {
                                    g.drawString(wrString, xPos, posy + (height - (int) (wr * height / 100)) - 2 * DOT_RADIUS);
                                }
                            } else {
                                if (wr < 10) {
                                    g.drawString(wrString, xPos, posy + (height - (int) (wr * height / 100)) - 2 * DOT_RADIUS);
            ...
            if (saveCurMovenum > 1) {
                ...
                if (curMove.getData().blackToPlay) {
                    g.setColor(Color.BLACK);
                    g.fillOval(posx + (saveCurMovenum * width / numMoves) - DOT_RADIUS, posy + height - (int) (saveCurWr * height / 100) - DOT_RADIUS, DOT_RADIUS * 2, DOT_RADIUS * 2);
                    Font f = new Font(Config.sysDefaultFontName, Font.BOLD, largeEnough ? 17 : 16);
                    g.setFont(f);
                    if (saveCurWr > 50) {
                        if (saveCurWr > 90) {
                            g.drawString(wrString, xPos, posy + (height - (int) (saveCurWr * height / 100)) + 6 * DOT_RADIUS);
                        } else {
                            g.drawString(wrString, xPos, posy + (height - (int) (saveCurWr * height / 100)) - 2 * DOT_RADIUS);
                        }
                    } else {
                        if (saveCurWr < 10) {
                            g.drawString(wrString, xPos, posy + (height - (int) (saveCurWr * height / 100)) - 2 * DOT_RADIUS);
            ...
            if (mode == 0) {
                    ...
                    if (playouts > 0) {
                        ...
                        if (node == curMove) {
                            ...
                            if (!noC) {
                                ...
                                if (wr < 3) {
                                    ...
                                    if (moveNum < 10)
                                        g.drawString(moveNumString, moveNum < numMoves / 2 ? x + 3 : x - 10, posy + fontHeight - margin);
                                    else if (Lizzie.board.getHistory().getCurrentHistoryNode().getData().moveNumber > 99)
                                        g.drawString(moveNumString, moveNum < numMoves / 2 ? x + 3 : x - 22, posy + fontHeight - margin);
                                    else
                                        g.drawString(moveNumString, moveNum < numMoves / 2 ? x + 3 : x - 16, posy + fontHeight - margin);
                                } else {
                                    if (moveNum < 10)
                                        g.drawString(moveNumString, moveNum < numMoves / 2 ? x + 3 : x - 10, posy + height - margin);
                                    else if (Lizzie.board.getHistory().getCurrentHistoryNode().getData().moveNumber > 99)
                                        ...
                                        g.drawString(moveNumString, moveNum < numMoves / 2 ? x + 3 : x - 16, posy + height - margin);
                                }
                            }
                            g.setStroke(previousStroke);
                        }
                        ...
                        if (lastOkMove > 0 && Math.abs(movenum - lastOkMove) < 25) {
                            if (Lizzie.config.showBlunderBar && canDrawBlunderBar) {
                                ...
                                lastHeight = Math.abs((int) (lastMoveRate) * height / 200);
                                // int lastWidth = Math.abs(2 * width / numMoves);
                                int rectWidth = Math.max(Lizzie.config.minimumBlunderBarWidth, (int) ((movenum + 1) * width / numMoves) - (int) (movenum * width / numMoves));
                                gBlunder.fillRect(posx + (int) (((movenum + lastOkMove - 1)) * width / numMoves / 2), blunderBottom - lastHeight, rectWidth, lastHeight);
                            }
                            g.drawLine(posx + (lastOkMove * width / numMoves), posy + height - (int) (lastWr * height / 100), posx + (movenum * width / numMoves), posy + height - (int) (wr * height / 100));
                        }
                        ...
                        if (topOfVariation.isPresent() && topOfVariation.get() == node && node.next().isPresent()) {
                        ...
                        if (node == curMove || (curMove.previous().isPresent() && node == curMove.previous().get() && curMove.getData().getPlayouts() <= 0)) {
                            g.setColor(Lizzie.config.winrateLineColor);
                            g.fillOval(posx + (movenum * width / numMoves) - DOT_RADIUS, posy + height - (int) (wr * height / 100) - DOT_RADIUS, DOT_RADIUS * 2, DOT_RADIUS * 2);
                            cwr = wr;
                            cmovenum = movenum;
                        ...
                        if (node == curMove) {
                            ...
                            if (!noC) {
                                ...
                                int moveNum = node.getData().moveNumber;
                                if (moveNum < 10)
                                    g.drawString(moveNumString, moveNum < numMoves / 2 ? x + 3 : x - 10, posy + height - strokeRadius);
                                else if (Lizzie.board.getHistory().getCurrentHistoryNode().getData().moveNumber > 99)
                                    g.drawString(moveNumString, moveNum < numMoves / 2 ? x + 3 : x - 22, posy + height - strokeRadius);
                                else
                                    g.drawString(moveNumString, moveNum < numMoves / 2 ? x + 3 : x - 16, posy + height - strokeRadius);
                            }
                            g.setStroke(previousStroke);
                        }
                    }
                ...
                while (node.previous().isPresent()) {
                    ...
                    if (node == curMove) {
                        ...
                        g.setStroke(dashed);
                        g.setColor(Color.WHITE);
                        if (curMove != Lizzie.board.getHistory().getEnd()) g.drawLine(x, posy, x, posy + height);
                    ...
                    if (playouts > 0) {
                        ...
                        if (lastOkMove > 0 && Math.abs(movenum - lastOkMove) < 25) {
                            ...
                            //    else g.setStroke(new BasicStroke(1f));
                            // g.setColor(Color.WHITE);
                            g.drawLine(posx + (lastOkMove * width / numMoves), posy + height - (int) ((100 - lastWr) * height / 100), posx + (movenum * width / numMoves), posy + height - (int) ((100 - wr) * height / 100));
                        }
                        ...
                        if (node == curMove || (curMove.previous().isPresent() && node == curMove.previous().get() && curMove.getData().getPlayouts() <= 0)) {
                            ...
                            if (wr > 50) {
                                if (wr > 90) {
                                    g.drawString(wrString, x, posy + (height - (int) (wr * height / 100)) + 6 * DOT_RADIUS);
                                } else {
                                    g.drawString(wrString, x, posy + (height - (int) (wr * height / 100)) - 2 * DOT_RADIUS);
                                }
                            } else {
                                if (wr < 10) {
                                    g.drawString(wrString, x, posy + (height - (int) (wr * height / 100)) - 2 * DOT_RADIUS);
                            ...
                            g.setFont(fw);
                            g.setColor(Color.WHITE);
                            g.fillOval(posx + (movenum * width / numMoves) - DOT_RADIUS, posy + height - (int) ((100 - wr) * height / 100) - DOT_RADIUS, DOT_RADIUS * 2, DOT_RADIUS * 2);
                            ...
                            if (wr > 50) {
                                if (wr < 90) {
                                    g.drawString(wrString, x, posy + (height - (int) ((100 - wr) * height / 100)) + 6 * DOT_RADIUS);
                                } else {
                                    g.drawString(wrString, x, posy + (height - (int) ((100 - wr) * height / 100)) - 2 * DOT_RADIUS);
                                }
                            } else {
                                if (wr > 10) {
                                    g.drawString(wrString, x, posy + (height - (int) ((100 - wr) * height / 100)) - 2 * DOT_RADIUS);
        ...
        if (Lizzie.config.showScoreLeadLine) {
            ...
            if (EngineManager.isEngineGame || Lizzie.board.isPkBoard) {
                ...
                if (EngineManager.isEngineGame && (Lizzie.engineManager.engineList.get(EngineManager.engineGameInfo.whiteEngineIndex).isKatago || Lizzie.engineManager.engineList.get(EngineManager.engineGameInfo.whiteEngineIndex).isSai) || Lizzie.board.isPkBoardKataW) {
                        ...
                        if (node.getData().getPlayouts() > 0) {
                            ...
                            if (lastOkMove > 0 && Math.abs(movenum - lastOkMove) < 25) {
                                ...
                                if (lastscoreMean > -500) {
                                    ...
                                    g.setStroke(new BasicStroke(1));
                                    g.drawLine(posx + ((lastOkMove) * width / numMoves), posy + height / 2 - (int) (convertScoreLead(lastscoreMean) * height / 2 / maxScoreLead), posx + ((movenum) * width / numMoves), posy + height / 2 - (int) (convertScoreLead(curscoreMean) * height / 2 / maxScoreLead));
                                    g.setStroke(previousStroke);
                                }
                            }
                            ...
                            if (EngineManager.isEngineGame && (!node.next().isPresent() || !node.next().get().next().isPresent())) {
                                curmovenum = movenum;
                    ...
                    if (lastscoreMean > -500) {
                        ...
                        g.setColor(Lizzie.config.scoreMeanLineColor);
                        g.setStroke(new BasicStroke(1));
                        g.drawLine(posx + ((lastOkMove) * width / numMoves), posy + height / 2 - (int) (convertScoreLead(lastscoreMean) * height / 2 / maxScoreLead), posx + ((movenum) * width / numMoves), posy + height / 2 - (int) (convertScoreLead(lastscoreMean) * height / 2 / maxScoreLead));
                        g.setStroke(previousStroke);
                    }
                    if (curmovenum > 0) {
                ...
                } else if (EngineManager.isEngineGame && (Lizzie.engineManager.engineList.get(EngineManager.engineGameInfo.blackEngineIndex).isKatago || Lizzie.engineManager.engineList.get(EngineManager.engineGameInfo.blackEngineIndex).isSai) || Lizzie.board.isPkBoardKataB) {
                    double lastscoreMean = -500;
                    int curmovenum = -1;
                    double drawcurscoreMean = 0;
                    if (!node.getData().blackToPlay) movenum -= 1;
        ...
        if (mwr >= 0) {
            ...
            g.fillOval(posx + (mmovenum * width / numMoves) - DOT_RADIUS, posy + height - (int) (mwr * height / 100) - DOT_RADIUS, DOT_RADIUS * 2, DOT_RADIUS * 2);
            g.setColor(Color.BLACK);
            Font f = new Font(Config.sysDefaultFontName, Font.BOLD, largeEnough ? 17 : 16);
            g.setFont(f);
