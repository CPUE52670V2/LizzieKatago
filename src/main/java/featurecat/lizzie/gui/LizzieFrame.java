...
public class LizzieFrame extends JFrame {
    private static final String[] commands = {Lizzie.resourceBundle.getString("LizzieFrame.commands.keySpace"), Lizzie.resourceBundle.getString("LizzieFrame.commands.keyN"), Lizzie.resourceBundle.getString("LizzieFrame.commands.keyEnter"),
            // "Enter(回车)|与引擎继续对弈",
            Lizzie.resourceBundle.getString("LizzieFrame.commands.mouseWheelScroll"), Lizzie.resourceBundle.getString("LizzieFrame.commands.keyComma"),
            // ",(逗号)或滚轮单击|落最佳一手,如果鼠标指向变化图则落子到变化图结束",
            Lizzie.resourceBundle.getString("LizzieFrame.commands.rightClick"), Lizzie.resourceBundle.getString("LizzieFrame.commands.keyA"), Lizzie.resourceBundle.getString("LizzieFrame.commands.keyG"), Lizzie.resourceBundle.getString("LizzieFrame.commands.keyR"),
            // "滚轮单击|落子到当前变化图结束",
            // "滚轮长按或R|快速回放鼠标指向的变化图",
            ...
            // "I|编辑棋局信息",
            Lizzie.resourceBundle.getString("LizzieFrame.commands.keySlash"), Lizzie.resourceBundle.getString("LizzieFrame.commands.keyB"),
            //  "T|返回主分支",
            Lizzie.resourceBundle.getString("LizzieFrame.commands.keyV"),
            // "V|试下",
            Lizzie.resourceBundle.getString("LizzieFrame.commands.keyF"), Lizzie.resourceBundle.getString("LizzieFrame.commands.keyZ"), Lizzie.resourceBundle.getString("LizzieFrame.commands.keyShiftF"),
            // "F|关闭/显示AI选点",
            Lizzie.resourceBundle.getString("LizzieFrame.commands.keyHandY"),
            // "H或Y|显示纯网络分析结果",
            // Lizzie.resourceBundle.getString("LizzieFrame.commands.keyI"),
            Lizzie.resourceBundle.getString("LizzieFrame.commands.key123456789"), Lizzie.resourceBundle.getString("LizzieFrame.commands.keyUpDownArrow"),
            // Lizzie.resourceBundle.getString("LizzieFrame.commands.keyDownArrow"),
            Lizzie.resourceBundle.getString("LizzieFrame.commands.keyC"), Lizzie.resourceBundle.getString("LizzieFrame.commands.keyP"), Lizzie.resourceBundle.getString("LizzieFrame.commands.keyM"), Lizzie.resourceBundle.getString("LizzieFrame.commands.keyAltC"), Lizzie.resourceBundle.getString("LizzieFrame.commands.keyAltV"), Lizzie.resourceBundle.getString("LizzieFrame.commands.keyJ"),
            // Lizzie.resourceBundle.getString("LizzieFrame.commands.keyV"),
            Lizzie.resourceBundle.getString("LizzieFrame.commands.keyW"), Lizzie.resourceBundle.getString("LizzieFrame.commands.keyCtrlW"), Lizzie.resourceBundle.getString("LizzieFrame.commands.keyShiftG"), Lizzie.resourceBundle.getString("LizzieFrame.commands.keyAltZ"), Lizzie.resourceBundle.getString("LizzieFrame.commands.keyBracket"), Lizzie.resourceBundle.getString("LizzieFrame.commands.keyCtrlT"), Lizzie.resourceBundle.getString("LizzieFrame.commands.keyHome"), Lizzie.resourceBundle.getString("LizzieFrame.commands.keyEnd"), Lizzie.resourceBundle.getString("LizzieFrame.commands.keyControl"), Lizzie.resourceBundle.getString("LizzieFrame.commands.keyDelete"), Lizzie.resourceBundle.getString("LizzieFrame.commands.keyE"),};
    ...
    public LizzieFrame() {
        ...
        varTreePane.addMouseListener(new MouseAdapter() {
        ...
        varTreePane.addMouseWheelListener(new MouseWheelListener() {
            @Override
        ...
        listTable.getTableHeader().setPreferredSize(new Dimension(listTable.getColumnModel().getTotalColumnWidth(), Lizzie.config.isFrameFontSmall() ? 20 : (Lizzie.config.isFrameFontMiddle() ? 24 : 28)));

        listTable.getTableHeader().setFont(new Font(Config.sysDefaultFontName, Font.PLAIN, Config.frameFontSize));
        ...
        varTreePane.addMouseMotionListener(new MouseAdapter() {
            public void mouseMoved(MouseEvent e) {
                if (!mainPanel.isFocusOwner()) mainPanel.requestFocus();
            }
        });
        listScrollpane.addMouseMotionListener(new MouseAdapter() {
            public void mouseMoved(MouseEvent e) {
                if (!mainPanel.isFocusOwner()) mainPanel.requestFocus();
            }
        });
        ...
        if (persisted) {
            if (Lizzie.config.persistedUi.optJSONArray("main-window-position") != null && Lizzie.config.persistedUi.optJSONArray("main-window-position").length() == 4) {
            ...
            if (Lizzie.config.persistedUi.getBoolean("window-maximized")) setExtendedState(Frame.MAXIMIZED_BOTH);
            if (Lizzie.config.persistedUi.optJSONArray("winrate-graph") != null && Lizzie.config.persistedUi.optJSONArray("winrate-graph").length() == 1) {
                JSONArray winrateG = Lizzie.config.persistedUi.getJSONArray("winrate-graph");
                winrateGraph.mode = winrateG.getInt(0);
            }
            this.BoardPositionProportion = Lizzie.config.persistedUi.optInt("board-postion-propotion", this.BoardPositionProportion);

            if (Lizzie.config.persistedUi.optJSONArray("main-window-other") != null && Lizzie.config.persistedUi.optJSONArray("main-window-other").length() == 5) {
            ...
            if (Lizzie.config.persistedUi.optJSONArray("main-window-list") != null && Lizzie.config.persistedUi.optJSONArray("main-window-list").length() == 5) {
            ...
            if (Lizzie.config.persistedUi.optJSONArray("main-window-blunder") != null && Lizzie.config.persistedUi.optJSONArray("main-window-blunder").length() == 3) {
        ...
        listTable.addMouseWheelListener(new MouseWheelListener() {
            @Override
            public void mouseWheelMoved(MouseWheelEvent e) {
                // TODO Auto-generated method stub
                if (clickOrder != -1) {
        ...
        tableTimer = new javax.swing.Timer(100, new ActionListener() {
                ...
                if (Lizzie.config.isShowingBlunderTabel) {
                    if (Lizzie.leelaz.isLoaded()) {
                        if (Lizzie.board.isKataBoard || Lizzie.leelaz.isKatago || Lizzie.leelaz.isSai) {
                            ...
                            if (!scoreIsHiddenInBlunderTable) {
                                blunderTableColum3Width = blunderTabelBlack.getColumnModel().getColumn(3).getWidth();
        ...
        commentTextArea.setFont(new Font(Lizzie.config.uiFontName, Font.PLAIN, Lizzie.config.commentFontSize > 0 ? Lizzie.config.commentFontSize : Config.frameFontSize));
        ...
        blunderContentPane.addMouseListener(new MouseAdapter() {
        ...
        final JMenuItem exportMenuBlunderBlack = new JFontMenuItem(Lizzie.resourceBundle.getString("JTabel.export"));
        exportBlunderBlack.add(exportMenuBlunderBlack);
        exportMenuBlunderBlack.addActionListener(new ActionListener() {
                ...
                try {
                    ...
                    if (option == JFileChooser.APPROVE_OPTION) {
                        ...
                        if (fname.indexOf(".xlsx") == -1) {
                            Utils.exportTable(blunderTabelBlack, chooser.getCurrentDirectory() + File.separator + fname + ".xls");
                        }
                    }
        ...
        blunderTabelBlack.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) {
                if (e.getButton() == MouseEvent.BUTTON3) {
                ...
                if (row >= 0 && col >= 0) {
                    try {
                        ...
                        int[] coords = Board.convertNameToCoordinates(blunderTabelBlack.getValueAt(row, 1).toString());
        ...
        final JMenuItem exportMenuBlunderWhite = new JFontMenuItem(Lizzie.resourceBundle.getString("JTabel.export"));
        exportBlunderWhite.add(exportMenuBlunderWhite);
        exportMenuBlunderWhite.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                try {
                    JFileChooser chooser = new JFileChooser();
                    FileNameExtensionFilter filter = new FileNameExtensionFilter("(*.xls)", "xls");
                    ...
                    if (option == JFileChooser.APPROVE_OPTION) {
                        ...
                        String fname = chooser.getName(file);
                        if (fname.indexOf(".xlsx") == -1) {
                            Utils.exportTable(blunderTabelWhite, chooser.getCurrentDirectory() + File.separator + fname + ".xls");
                        }
                    }
        ...
        blunderTabelWhite.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) {
                if (e.getButton() == MouseEvent.BUTTON3) {
                ...
                if (row >= 0 && col >= 0) {
                    try {
                        ...
                        int[] coords = Board.convertNameToCoordinates(blunderTabelWhite.getValueAt(row, 1).toString());
                        Lizzie.board.goToMoveNumber(movenumber - 1);
                        Lizzie.frame.clickbadmove = coords;
                        Lizzie.frame.repaint();
                    } catch (Exception ex) {
        ...
        blunderTabelBlack.getTableHeader().addMouseListener(new MouseAdapter() {
            public void mouseReleased(MouseEvent e) {
                ...
                Lizzie.config.saveBlunderTableSortSettings(blunderSortNum, blunderIsSorted, blunderSortIsOriginOrder);
                blunderTabelBlack.repaint();
                blunderTabelWhite.repaint();
            }
        });
        ...
        blunderTabelWhite.getTableHeader().addMouseListener(new MouseAdapter() {
            public void mouseReleased(MouseEvent e) {
        ...
        setTabelStyle(blunderTabelBlack, blunderTableColum0Width, blunderTableColum2Width, blunderTableColum3Width);
        setTabelStyle(blunderTabelWhite, blunderTableColum0Width, blunderTableColum2Width, blunderTableColum3Width);
        ...
        minScrollpaneBlack.addMouseListener(new MouseAdapter() {
            public void mouseExited(MouseEvent e) {
                if (Lizzie.config.hideBlunderControlPane) {
                    return;
                }
        ...
        minScrollpaneWhite.addMouseListener(new MouseAdapter() {
            public void mouseExited(MouseEvent e) {
                if (Lizzie.config.hideBlunderControlPane) {
                    return;
                }
        ...
        //        javax.swing.ScrollPaneConstants.VERTICAL_SCROLLBAR_ALWAYS);
        minScrollpaneBlack.getVerticalScrollBar().addMouseListener(new MouseAdapter() {
            public void mouseExited(MouseEvent e) {
                if (Lizzie.config.hideBlunderControlPane) {
                    return;
                }
        ...
        minScrollpaneWhite.getVerticalScrollBar().addMouseListener(new MouseAdapter() {
            public void mouseExited(MouseEvent e) {
                if (Lizzie.config.hideBlunderControlPane) {
                    return;
                }
        ...
        commentBlunderControlPane.addMouseListener(new MouseAdapter() {
            public void mouseExited(MouseEvent e) {
                commentBlunderControlPane.setVisible(false);
            }
        ...
        // commentScrollPane.getViewport().setOpaque(false);
        commentScrollPane.setVerticalScrollBarPolicy(javax.swing.ScrollPaneConstants.VERTICAL_SCROLLBAR_AS_NEEDED);
        ...
        showPlayouts.scheduleAtFixedRate(new Runnable() {
            @Override
            public void run() {
                boolean notPondering = Lizzie.leelaz == null || EngineManager.isEmpty || !Lizzie.leelaz.isPondering();
                try {
                    autosaveMaybe();
                ...
                try {
                    int totalPlayouts = Lizzie.board.getHistory().getCurrentHistoryNode().getData().getPlayouts();
                    int tempCount = getLastVisitsCount(visitsCount);
                    if (tempCount >= 0) {
                        long speed = (totalPlayouts - lastPlayouts) / tempCount;
                        if (speed >= 0) {
                            visitsString = String.format(" %d " + Lizzie.resourceBundle.getString("LizzieFrame.speedUnit"), speed);
                        }
                    }
                    visitsCount++;
    ...
    private AbstractTableModel getBlunderModel(boolean isBlack) {
        return new AbstractTableModel() {
            ...
            public int getRowCount() {
                ...
                while (!Lizzie.config.blunderTabelOnlyAfter && lastNode.previous().isPresent() || (Lizzie.config.blunderTabelOnlyAfter && lastNode != Lizzie.board.getHistory().getCurrentHistoryNode() && lastNode.previous().isPresent())) {
                    NodeInfo nodeInfoThis = lastNode.nodeInfo;
                    if (nodeInfoThis.analyzed) if (nodeInfoThis.isBlack == isBlack)
                        if (Math.abs(nodeInfoThis.diffWinrate) >= Lizzie.config.blunderWinThreshold)
                            if (nodeInfoThis.playouts >= Lizzie.config.blunderPlayoutsThreshold && nodeInfoThis.previousPlayouts >= Lizzie.config.blunderPlayoutsThreshold)
                                if (!lastNode.getData().isKataData || Math.abs(nodeInfoThis.scoreMeanDiff) >= Lizzie.config.blunderScoreThreshold)
                                    row = row + 1;
            ...
            public String getColumnName(int column) {
                switch (column) {
                    case 0:
                        return isBlack ? Lizzie.resourceBundle.getString("BlunderTabel.black") : Lizzie.resourceBundle.getString("BlunderTabel.white");
                    case 1:
                ...
                if (nodeInfoThis.analyzed) if (nodeInfoThis.isBlack == isBlack)
                    if (Math.abs(nodeInfoThis.diffWinrate) >= Lizzie.config.blunderWinThreshold)
                        if (nodeInfoThis.playouts >= Lizzie.config.blunderPlayoutsThreshold && nodeInfoThis.previousPlayouts >= Lizzie.config.blunderPlayoutsThreshold)
                            if (!lastNode.getData().isKataData || Math.abs(nodeInfoThis.scoreMeanDiff) >= Lizzie.config.blunderScoreThreshold)
                                data2.add(nodeInfoThis);
                Collections.sort(data2, new Comparator<NodeInfo>() {
                    @Override
                ...
                if (data2.size() > row) {
                    ...
                    if (Lizzie.board.isPkBoard) {
                        switch (col) {
                            ...
                            case 2:
                                return (data.diffWinrate < 0 ? "+" : "-") + String.format(Locale.ENGLISH, "%.2f", Math.abs(data.diffWinrate));
                            case 3:
                                return (data.scoreMeanDiff < 0 ? "+" : "-") + String.format(Locale.ENGLISH, "%.2f", Math.abs(data.scoreMeanDiff));
                            default:
                                return "";
                        }
                    } else {
    ...
    private void setTabelStyle(JTable table, int column0, int column1, int column2) {
        ...
        table.getTableHeader().setPreferredSize(new Dimension(table.getColumnModel().getTotalColumnWidth(), Lizzie.config.isFrameFontSmall() ? 20 : (Lizzie.config.isFrameFontMiddle() ? 24 : 28)));
        table.getTableHeader().setFont(new Font(Config.sysDefaultFontName, Font.PLAIN, Config.frameFontSize));
    ...
    public void setBlunderControlPane(boolean fromComment, boolean resetPos) {
        ...
        chkComment.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                // TBD
        ...
        chkBlunder.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                // TBD
                menu.txtKomi.setFocusable(false);
        ...
        chkBlunder.addMouseListener(new MouseAdapter() {
            public void mouseExited(MouseEvent e) {
                commentBlunderControlPane.setVisible(false);
            }
        ...
        chkComment.addMouseListener(new MouseAdapter() {
            public void mouseExited(MouseEvent e) {
                commentBlunderControlPane.setVisible(false);
            }
        ...
        if (!fromComment) {
            JCheckBox chkOnlyAfter = new JCheckBox(Lizzie.resourceBundle.getString("LizzieFrame.chkOnlyAfter"));
            chkOnlyAfter.setSelected(Lizzie.config.blunderTabelOnlyAfter);
            chkOnlyAfter.addActionListener(new ActionListener() {
                @Override
                public void actionPerformed(ActionEvent e) {
                    // TBD未完成
                    Lizzie.config.blunderTabelOnlyAfter = chkOnlyAfter.isSelected();
                    Lizzie.config.uiConfig.put("blunder-table-only-after", Lizzie.config.blunderTabelOnlyAfter);
                    setBlunderSort();
                    blunderTabelBlack.revalidate();
                    blunderTabelWhite.revalidate();
                }
            });
            JButton setThreshold = new JButton(Lizzie.resourceBundle.getString("LizzieFrame.setThreshold"));
            ...
            chkOnlyAfter.addMouseListener(new MouseAdapter() {
                public void mouseExited(MouseEvent e) {
                    commentBlunderControlPane.setVisible(false);
                }
            ...
            setThreshold.addMouseListener(new MouseAdapter() {
                public void mouseExited(MouseEvent e) {
                    commentBlunderControlPane.setVisible(false);
                }
                ...
                SwingUtilities.invokeLater(new Runnable() {
                    public void run() {
                        if (Lizzie.config.allowCloseCommentControlHint) {
                            Object[] options = {Lizzie.resourceBundle.getString("LizzieFrame.confirm"), Lizzie.resourceBundle.getString("LizzieFrame.cancel"), Lizzie.resourceBundle.getString("LizzieFrame.noNoticeAgain")};
                            int response = JOptionPane.showOptionDialog(Lizzie.frame, Lizzie.resourceBundle.getString("LizzieFrame.closeCommentBar"), Lizzie.resourceBundle.getString("LizzieFrame.closeCommentBarTitle"), JOptionPane.YES_OPTION, JOptionPane.QUESTION_MESSAGE, null, options, options[0]);
                            if (response == -1) {

                            } else if (response == 0) {
                                Lizzie.config.hideBlunderControlPane = true;
                                Lizzie.config.uiConfig.put("hide-blunder-table-control-pane", Lizzie.config.hideBlunderControlPane);
                                commentBlunderControlPane.setBounds(0, 0, 0, 0);
                                commentBlunderControlPane.setVisible(false);
                            } else if (response == 1) {
                            } else if (response == 2) {
                                ...
                                Lizzie.config.uiConfig.put("allow-close-comment-control-hint", Lizzie.config.allowCloseCommentControlHint);
                            }
                        } else {
                            Lizzie.config.hideBlunderControlPane = true;
                            Lizzie.config.uiConfig.put("hide-blunder-table-control-pane", Lizzie.config.hideBlunderControlPane);
        ...
        if (resetPos) {
            if (fromComment) {
                if (commentScrollPane.getY() > 20)
                    commentBlunderControlPane.setBounds(commentScrollPane.getX(), commentScrollPane.getY() - 20, Lizzie.config.isChinese ? 135 : 192, 20);
                else if (commentScrollPane.getX() + commentScrollPane.getHeight() + 20 <= Lizzie.frame.getHeight() - Lizzie.frame.getJMenuBar().getHeight() - Lizzie.frame.getInsets().top - Lizzie.frame.getInsets().bottom - toolbarHeight)
                    commentBlunderControlPane.setBounds(commentScrollPane.getX(), commentScrollPane.getY() + commentScrollPane.getHeight(), Lizzie.config.isChinese ? 135 : 192, 20);
                else
                    commentBlunderControlPane.setBounds(commentScrollPane.getX(), commentScrollPane.getY() + commentScrollPane.getHeight() - 20, Lizzie.config.isChinese ? 135 : 192, 20);
                ...
                if (blunderContentPane.getY() > 20)
                    commentBlunderControlPane.setBounds(blunderContentPane.getX(), blunderContentPane.getY() - 20, Lizzie.config.isChinese ? 231 : 305, 20);
                else if (blunderContentPane.getX() + blunderContentPane.getHeight() + 20 <= Lizzie.frame.getHeight() - Lizzie.frame.getJMenuBar().getHeight() - Lizzie.frame.getInsets().top - Lizzie.frame.getInsets().bottom - toolbarHeight)
                    commentBlunderControlPane.setBounds(blunderContentPane.getX(), blunderContentPane.getY() + blunderContentPane.getHeight(), Lizzie.config.isChinese ? 231 : 305, 20);
                else
                    commentBlunderControlPane.setBounds(blunderContentPane.getX(), blunderContentPane.getY() + blunderContentPane.getHeight() - 20, Lizzie.config.isChinese ? 231 : 305, 20);
            }
        } else {
            commentBlunderControlPane.setSize(fromComment ? Lizzie.config.isChinese ? 135 : 192 : Lizzie.config.isChinese ? 231 : 305, 20);
        }
    }
    ...
    public boolean openRightClickMenu(int x, int y) {
        ...
        if (Lizzie.board.getstonestat(coords) == Stone.BLACK || Lizzie.board.getstonestat(coords) == Stone.WHITE) {
    ...
    public void tryPlay(boolean needRefresh) {
        ...
        if (!isTrying) {
            ...
            toolbar.tryPlay.setText(Lizzie.resourceBundle.getString("BottomToolbar.tryplayBack")); // ("恢复");
    ...
    public void toggleAnalysisFrameAlwaysontop() {
        if (analysisFrame != null && analysisFrame.isVisible()) {
            if (analysisFrame.isAlwaysOnTop()) {
                if (Lizzie.config.isDoubleEngineMode()) if (analysisFrame2 != null && analysisFrame2.isVisible()) {
    ...
    public void countstones(boolean shouldRetart) {
        ...
        if (Lizzie.config.showKataGoEstimate && !Lizzie.config.isHiddenKataEstimate && Lizzie.leelaz.isKatago) {
            Lizzie.config.showKataGoEstimate = false;
            clearKataEstimate();
            Lizzie.leelaz.ponder();
        }
        if (shouldRetart) {
            if (zen == null || zen.useJavaSSH && zen.javaSSHClosed || (!zen.useJavaSSH && (zen.process == null || !zen.process.isAlive()))) {
                try {
    ...
    public void extraMode(ExtraMode currentMode, ExtraMode previousMode) {
        ...
        if (currentMode == ExtraMode.Four_Sub) {
            ...
            if (!windowIsMaximized) {
                Lizzie.frame.setBounds(Lizzie.frame.getX(), Lizzie.frame.getY(), (Lizzie.frame.getHeight() - toolbarHeight) * 162 / 100, Lizzie.frame.getHeight());
            }
        }
        if (currentMode == ExtraMode.Double_Engine) {
            ...
            boardRenderer2.setOrder(1);
            if (!windowIsMaximized) {
                Lizzie.frame.setBounds(Lizzie.frame.getX(), Lizzie.frame.getY(), (Lizzie.frame.getHeight() - toolbarHeight - 65) * 2, Lizzie.frame.getHeight());
            }
        ...
        if (currentMode == ExtraMode.Thinking) {
            ...
            boardRenderer2.setDisplayedBranchLength(BoardRenderer.SHOW_RAW_BOARD);
            if (!windowIsMaximized) {
                Lizzie.frame.setBounds(Lizzie.frame.getX(), Lizzie.frame.getY(), (Lizzie.frame.getHeight() - toolbarHeight) * 166 / 100, Lizzie.frame.getHeight());
            }
        }
        if (currentMode != ExtraMode.Thinking && currentMode != ExtraMode.Four_Sub) {
            setHideListScrollpane(false);
        } else if (Lizzie.config.showListPane()) {
    ...
    public void minMode() {
        ...
        if (!windowIsMaximized) {
            int minlength = Math.min(Lizzie.frame.getWidth(), Lizzie.frame.getHeight() - Lizzie.frame.toolbarHeight);
            Lizzie.frame.setBounds(Lizzie.frame.getX(), Lizzie.frame.getY(), (int) (minlength * 0.94), minlength + Lizzie.frame.toolbarHeight);
            reSetLoc();
        }
        Lizzie.frame.refresh();
    }
    ...
    public void independentBoardMode(boolean showSubBoard) {
        ...
        if (Lizzie.frame.getExtendedState() != JFrame.MAXIMIZED_BOTH) {
            Lizzie.frame.setBounds(Lizzie.frame.getX(), Lizzie.frame.getY(), (Lizzie.frame.getHeight() - toolbarHeight) * 65 / 100, Lizzie.frame.getHeight());
        }
        if (showSubBoard) {
            if (!Lizzie.config.showSubBoard) Lizzie.config.toggleShowSubBoard();
        } else {
    ...
    public void classicMode() {
        ...
        if (!windowIsMaximized) {
            Lizzie.frame.setBounds(Lizzie.frame.getX(), Lizzie.frame.getY(), (Lizzie.frame.getHeight() - toolbarHeight) * 145 / 100, Lizzie.frame.getHeight());
            reSetLoc();
        }
    ...
    public void defaultMode() {
        ...
        if (!windowIsMaximized) {
            Lizzie.frame.setBounds(Lizzie.frame.getX(), Lizzie.frame.getY(), (Lizzie.frame.getHeight() - toolbarHeight) * 165 / 100, Lizzie.frame.getHeight());
            reSetLoc();
        }
        Lizzie.frame.refresh();
    }
    ...
    public static void sendAiTime(boolean needCountDown, Leelaz engine, boolean showTimeMsg) {
        if (Lizzie.config.advanceTimeSettings) {
            ...
            if (needCountDown) {
                ...
                if (!Lizzie.engineManager.playingAgainstHumanEngineCountDown.setEngineCountDown(Lizzie.config.advanceTimeTxt, Lizzie.leelaz)) {
                    Lizzie.engineManager.playingAgainstHumanEngineCountDown = null;
                    Utils.showMsgNoModal(Lizzie.resourceBundle.getString("EngineManager.parseAdvcanceTimeSettingsFailed"));
                } else {
            ...
            if (Lizzie.config.kataTimeSettings) {
                ...
                switch (Lizzie.config.kataTimeType) {
                    case 0:
                        txtKataTimeSettings += "byoyomi " + Lizzie.config.kataTimeMainTimeMins * 60 + " " + Lizzie.config.kataTimeByoyomiSecs + " " + Lizzie.config.kataTimeByoyomiTimes;
                        break;
                    case 1:
                        txtKataTimeSettings += "fischer " + Lizzie.config.kataTimeMainTimeMins * 60 + " " + Lizzie.config.kataTimeFisherIncrementSecs;
                        break;
                    case 2:
                ...
                if (needCountDown) {
                    Lizzie.engineManager.playingAgainstHumanEngineCountDown = new EngineCountDown();
                    if (!Lizzie.engineManager.playingAgainstHumanEngineCountDown.setEngineCountDown(txtKataTimeSettings, Lizzie.leelaz)) {
                        Lizzie.engineManager.playingAgainstHumanEngineCountDown = null;
                        Utils.showMsgNoModal(Lizzie.resourceBundle.getString("EngineManager.parseAdvcanceTimeSettingsFailed"));
                    } else {
                        Lizzie.engineManager.playingAgainstHumanEngineCountDown.initialize(!Lizzie.frame.playerIsBlack);
                ...
                if (showTimeMsg && !engine.isKatago) {
                    Utils.showMsg(Lizzie.resourceBundle.getString("LizzieFrame.sendTimes.kataGoTimeMismatch")); // "引擎时间设置为KataGo专用,但当前引擎不是KataGo,可能无法正确控制时间!");
                }
            } else engine.sendCommand("time_settings 0 " + Lizzie.config.maxGameThinkingTimeSeconds + " 1");
        }
    }
    ...
    public void startNewGame() {
        if (Lizzie.frame.isContributing) {
            Utils.showMsg(Lizzie.resourceBundle.getString("Contribute.tips.contributingAndStartAnotherLizzieYzy"));
            return;
        }
        ...
        Runnable syncBoard = new Runnable() {
            public void run() {
                ...
                if (Lizzie.config.limitMyTime)
                    countDownForHuman(Lizzie.config.getMySaveTime(), Lizzie.config.getMyByoyomiSeconds(), Lizzie.config.getMyByoyomiTimes());
                if (!Lizzie.config.genmoveGameNoTime) {
                    sendAiTime(true, Lizzie.leelaz, true);
                }
                ...
                if (isHandicapGame) {
                    ...
                    } else if (playerIsBlack && !Lizzie.board.getHistory().isBlacksTurn()) Lizzie.leelaz.genmove("w");
                }
                GameInfo gameInfo = Lizzie.board.getHistory().getGameInfo();
                gameInfo.setPlayerBlack(playerIsBlack ? Lizzie.resourceBundle.getString("NewAnaGameDialog.me") : Lizzie.leelaz.oriEnginename);
                gameInfo.setPlayerWhite(playerIsBlack ? Lizzie.leelaz.oriEnginename : Lizzie.resourceBundle.getString("NewAnaGameDialog.me"));
    ...
    public void saveRawFileComment() {
        ...
        if (result == JFileChooser.APPROVE_OPTION) {
            ...
            if (file.exists()) {
                int ret = JOptionPane.showConfirmDialog(Lizzie.frame, Lizzie.resourceBundle.getString("LizzieFrame.prompt.sgfExists"), Lizzie.resourceBundle.getString("LizzieFrame.warning"), JOptionPane.OK_CANCEL_OPTION);
    ...
    public void saveOriFile() {
        if (curFile != null && !curFile.getName().toLowerCase().endsWith(".gib")) {
            if (Lizzie.config.showReplaceFileHint) {
                ...
                JFontLabel label = new JFontLabel(Lizzie.resourceBundle.getString("LizzieFrame.ifReplaceFile") + curFile.getName() + "\" ?");
                label.setAlignmentX(Component.LEFT_ALIGNMENT);
                box.add(label);
                Utils.addFiller(box, 5, 5);
                JFontLabel label2 = new JFontLabel(Lizzie.resourceBundle.getString("LizzieFrame.replaceFileNotice"));
                label2.setAlignmentX(Component.LEFT_ALIGNMENT);
                box.add(label2);
                Utils.addFiller(box, 5, 5);
                JFontCheckBox disableCheckBox = new JFontCheckBox(Lizzie.resourceBundle.getString("LizzieFrame.noNoticeAgain")); // LizzieFrame.noNoticeAgain
                ...
                JOptionPane optionPane = new JOptionPane(box, JOptionPane.QUESTION_MESSAGE, JOptionPane.YES_NO_OPTION, null, options, defaultOption);
                JDialog dialog = optionPane.createDialog(this, Lizzie.resourceBundle.getString("LizzieFrame.replaceFileTitle"));
    ...
    public static void saveCurrentBranch() {
        ...
        if (result == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                ...
                Lizzie.board.setMoveListWithFlatten(Lizzie.board.tempallmovelist, startMoveNumber, blackToPlay);
                isSavingRaw = true;
                SGFParser.save(Lizzie.board, file.getPath());
                isSavingRaw = false;
                if (file.getParent() != null) {
    ...
    public void openFile() {
        ...
        JSONObject filesystem = Lizzie.config.persisted.getJSONObject("filesystem");
        this.setAlwaysOnTop(false);
        FileDialog fileDialog = new FileDialog(this, Lizzie.resourceBundle.getString("LizzieFrame.chooseKifu"));
    ...
    public void openSgfStart() {
        ...
        JSONObject filesystem = Lizzie.config.persisted.getJSONObject("filesystem");
        this.setAlwaysOnTop(false);
        FileDialog fileDialog = new FileDialog(this, Lizzie.resourceBundle.getString("LizzieFrame.chooseOpeningSgf"));
    ...
    public void loadFile(File file, boolean fromTemp, boolean showHint) {
        ...
        try {
            ...
            SwingUtilities.invokeLater(new Runnable() {
                public void run() {
                    JOptionPane.showConfirmDialog(Lizzie.frame, Lizzie.resourceBundle.getString("LizzieFrame.prompt.failedToOpenFile"), "Error", JOptionPane.ERROR);
                }
            });
        }
        Lizzie.board.setMovelistAll();
        if (showHint) {
            ...
            if (!Lizzie.config.isFloatBoardMode() && !(analysisTable != null && analysisTable.frame.isVisible()))
    ...
    public void paintMianPanel(Graphics g0) {
        if (redrawWinratePaneOnly) {
            ...
            if (!Lizzie.config.usePureBackground && (cachedBackgroundWidth != width || cachedBackgroundHeight != height || redrawBackgroundAnyway)) {
            ...
            if (!showControls) {
                ...
                if (Lizzie.config.isFourSubMode()) {
                    ...
                    String statusText = Lizzie.resourceBundle.getString(statusKey) + (Lizzie.config.userKnownX ? "" : Lizzie.resourceBundle.getString("LizzieFrame.display.space"));
                    ...
                    String text1 = Lizzie.resourceBundle.getString("LizzieFrame.mainEngine") + weightText + " " + ponderingText + " " + statusText;

                    commentX1 = drawPonderingStateForExtraMode2(g, text1, leftInset, maxSize, 18);
                    if (Lizzie.leelaz2 != null) {
                        weightText2 = Lizzie.leelaz2.oriEnginename;
                        String statusKey2 = "LizzieFrame.display." + (Lizzie.leelaz.isPondering() ? "on" : "off");
                        String statusText2 = Lizzie.resourceBundle.getString(statusKey2);
                        String ponderingText2 = Lizzie.resourceBundle.getString("LizzieFrame.display.pondering");
                        if (weightText2.length() > 15) weightText2 = weightText2.substring(0, 10);
                        String text2 = Lizzie.resourceBundle.getString("LizzieFrame.subEngine") + weightText2 + " " + ponderingText2 + " " + statusText2;
                    ...
                    String text1comm = Lizzie.resourceBundle.getString("LizzieFrame.visits") + Utils.getPlayoutsString(Lizzie.board.getData().getPlayouts()) + " " + Lizzie.resourceBundle.getString("LizzieFrame.winrate") + String.format(Locale.ENGLISH, "%.1f%%", Lizzie.board.getData().winrate);
                    drawPonderingStateForExtraMode2(g, text1comm, leftInset + commentX1 + 5, maxSize, 18);

                    String text2comm = Lizzie.resourceBundle.getString("LizzieFrame.visits") + Utils.getPlayoutsString(Lizzie.board.getData().getPlayouts2()) + " " + Lizzie.resourceBundle.getString("LizzieFrame.winrate") + String.format(Locale.ENGLISH, "%.1f%%", Lizzie.board.getData().winrate2);
                    drawPonderingStateForExtraMode2(g, text2comm, maxSize + leftInset + commentX2 + 5, maxSize, 18);
                    //  }
                ...
                //  extrmode 8
                    ...
                    int ponderingY = height - bottomInset; // - (int) (maxSize * 0.023) - (int) (maxBound * ponderingSize);
                    int ponderingY2 = height - bottomInset; // - (int) (maxSize * 0.023) - (int) (maxBound * ponderingSize *
                    // 0.4);
                    if (Lizzie.config.showStatus) {
                        ponderingY = ponderingY - (int) (maxSize * 0.023) - (int) (maxBound * ponderingSize);
                        ponderingY2 = ponderingY2 - (int) (maxSize * 0.023) - (int) (maxBound * ponderingSize * (Lizzie.config.userKnownX ? 0.3 : 0.4));
                    }
                    double loadingSize = 0.03;
                    int loadingX = ponderingX;
                    int loadingY = ponderingY - (int) (maxBound * (loadingSize - ponderingSize * (Lizzie.config.userKnownX ? 1.15 : 0.75)));
                    ...
                    if (!noListPane) {
                        if (noSubBoard) {
                            ...
                            if (noVariation) {
                                ...
                                setListScrollpane(vx, vy + (vh - subBoardLength) / 2, vw, (vh - subBoardLength) / 2);
                            }
                        }
                    }
                    if (!noWinrate) {
                    ...
                    boolean noSubBoard = !Lizzie.config.showSubBoard;
                    boolean noComment = !Lizzie.config.showComment;
                    boolean isLargeSubboard = Lizzie.config.showLargeSubBoard() && !Lizzie.config.largeWinrateGraph;
                    // board
                    maxSize = (int) (min(width - leftInset - rightInset, height - topInset - bottomInset));
                    maxSize = max(maxSize, max(Board.boardWidth, Board.boardHeight) + 5);
                    ...
                    if (isWidthMode) {
                        ...
                        //          }
                        if (Lizzie.config.showWinrateGraph) {
                            if (Lizzie.config.showLargeSubBoard() && noComment && noVariation && noVariation && !showListPane && !Lizzie.config.showCaptured) {
                                staty -= caph;
                            }
                        ...
                        if (backgroundG.isPresent()) {
                            ...
                            if (Lizzie.config.showCaptured) {
                                if (Lizzie.config.showLargeSubBoard() && !noSubBoard && !Lizzie.config.showWinrateGraph)
                        ...
                        if (Lizzie.config.showVariationGraph || showListPane || Lizzie.config.showComment) {
                            ...
                            if (Lizzie.config.showVariationGraph || showListPane) {
                                ...
                                if ((Lizzie.config.showLargeSubBoard() || Lizzie.config.showLargeWinrate()) && !Lizzie.config.showCaptured)
    ...
    private String getLoadingText() {
        // TODO Auto-generated method stub
        if (Lizzie.leelaz.isDownWithError) return Lizzie.resourceBundle.getString("LizzieFrame.display.down");
        else if (Lizzie.leelaz.isTuning) return Lizzie.resourceBundle.getString("LizzieFrame.display.tuning");
    ...
    public void refreshContainer() {
        ...
        if (Lizzie.config.isFloatBoardMode()) {
            this.paintMianPanel(mainPanel.getGraphics());
        }
    }
    ...
    public void refresh() {
        ...
        redrawWinratePaneOnly = false;
        basePanel.repaint();
        if (independentSubBoard != null && independentSubBoard.isVisible()) independentSubBoard.refresh();
        if (independentMainBoard != null && independentMainBoard.isVisible()) independentMainBoard.refresh();
    ...
    private Graphics2D createBackground(int width, int hight) {
        ...
        if (backgroundPaint == null) {
            ...
            backgroundPaint = new TexturePaint(result, new Rectangle(0, 0, result.getWidth(), result.getHeight()));
        }
    ...
    private void drawContainer(Graphics g, int vx, int vy, int vw, int vh) {
        if (Lizzie.config.usePureBackground || vw <= 0 || vh <= 0 || vx < cachedBackground.getMinX() || vx + vw > cachedBackground.getMinX() + cachedBackground.getWidth() || vy < cachedBackground.getMinY() || vy + vh > cachedBackground.getMinY() + cachedBackground.getHeight()) {
            return;
        }
    ...
    private void drawPonderingState(Graphics2D g, String text, int x, int y, double size) {
        ...
        if (!Lizzie.config.isFloatBoardMode()) {
            if (Lizzie.leelaz != null && Lizzie.leelaz.isLoaded()) {
                int mainBoardX = boardRenderer.getLocation().x;
                if (mainPanel.getWidth() > mainPanel.getHeight() && (mainBoardX > x) && stringWidth > (mainBoardX - x)) {
                    text = truncateStringByWidth(text, fm, mainBoardX - x);
                    stringWidth = fm.stringWidth(text);
                }
            }
    ...
    private void drawPonderingState2(Graphics2D g, String text, int x, int y, double size) {
        ...
        String partFirst = text.split(",")[0];
        g.setColor(Color.white);
        g.setFont(font);
        g.drawString(partFirst, x + (width - stringWidth) / 2, y + stringHeight + (height - stringHeight) / 2);

        String partSceond = text.split(",")[1];
        stringWidth = fm.stringWidth(partFirst);
        Color colorTemp = Lizzie.leelaz.isPondering() ? Color.GREEN : Color.RED;
        g.setColor(colorTemp);
        g.setFont(font);
        g.drawString(partSceond, x + stringWidth, y + stringHeight + (height - stringHeight) / 2);


        if (text.split(",").length == 3) {
            stringWidth = fm.stringWidth(partFirst + partSceond);
            String partThird = text.split(",")[2];
            g.setColor(Color.white);
            g.setFont(font);
            g.drawString(partThird, x + stringWidth, y + stringHeight + (height - stringHeight) / 2);
        }
    ...
    void drawControls() {
        ...
        int commandsY = top + min((mainPanel.getHeight() - top) / 2 - boxHeight / 2, mainPanel.getHeight() - top);
    ...
    private void drawMoveStatistics(Graphics2D g, int posX, int posY, int width, int height) {
        ...
        if (isInPlayMode()) {
            ...
            if (isShowingByoTime) {
                String byoString = ((this.leftMinuts > 0 || this.leftSeconds > 0) ? (Lizzie.resourceBundle.getString("Byoyomi.time") + this.leftMinuts + ":" + this.leftSeconds + " ") : "") + (this.byoSeconds >= 0 ? (" " + Lizzie.resourceBundle.getString("Byoyomi.byoyomi") + this.byoSeconds + "(" + Lizzie.frame.byoTimes + ")") : "");
                g.setColor(Color.WHITE);
                drawString(g, posX, posY + height / 2, uiFont, Font.PLAIN, byoString, height, width, 0, true);
            }
            return;
        }
...
//            text = text + (Lizzie.config.showKataGoScoreLeadWithKomi ? Lizzie.resourceBundle.getString("LizzieFrame.scoreLeadWithKomi") : Lizzie.resourceBundle.getString("LizzieFrame.scoreLeadJustScore")) + String.format(Locale.ENGLISH, "%.1f", scoreLead);
        ...
        if (validWinrate || validLastWinrate) {
            ...
            if (validWinrate && validLastWinrate) {
                ...
                if (diffWidth > 0) {
                    ...
                    if (rightTri) {
                        ...
                        int[] yPoints = {barPosY + 1 - (isGig ? 5 : 3), barPosY + 1 + (isGig ? 5 : 3), barPosY + 1};
                        g.fillPolygon(xPoints, yPoints, 3);
                    }
            ...
            g.drawString(winStringB, barPosxB + 2 * strokeRadius, posY + barHeight - (barHeight - fontHeigt) / 2);
            int swW = g.getFontMetrics().stringWidth(winStringW);
            g.drawString(winStringW, barPosxB + maxBarwidth - swW - 2 * strokeRadius, posY + barHeight - (barHeight - fontHeigt) / 2);
            if (shouldDrawMoveNumberDown()) {
                int swB = g.getFontMetrics().stringWidth(winStringB);
                String moveNumber = String.valueOf(Lizzie.board.getHistory().getCurrentHistoryNode().getData().moveNumber);
                int swM = g.getFontMetrics().stringWidth(moveNumber);
                if (maxBarwidth > 2 * (swM) + swB + swW) {
                    g.drawString(moveNumber, barPosxB + (maxBarwidth - swM) / 2, posY + barHeight - (barHeight - fontHeigt) / 2);
                }
            }
            g.setColor(Color.GRAY);
            Stroke oldstroke = g.getStroke();
    ...
    private boolean shouldDrawMoveNumberDown() {
        if (EngineManager.isEngineGame) {
            if (Lizzie.engineManager.engineList.get(EngineManager.engineGameInfo.whiteEngineIndex).isKatago && Lizzie.engineManager.engineList.get(EngineManager.engineGameInfo.whiteEngineIndex).usingSpecificRules > 0)
                return true;
            if (Lizzie.engineManager.engineList.get(EngineManager.engineGameInfo.blackEngineIndex).isKatago && Lizzie.engineManager.engineList.get(EngineManager.engineGameInfo.blackEngineIndex).usingSpecificRules > 0)
                return true;
        }
    ...
    private void drawCaptured(Graphics2D g, int posX, int posY, int width, int height, boolean isSmallCap) {
        ...
        // Draw middle line
        g.drawLine(posX - strokeRadius + width / 2, posY + 3 * strokeRadius, posX - strokeRadius + width / 2, posY - strokeRadius + height);
        g.setColor(Color.white);
        ...
        //我们让左上方的对战信息黑白标志改成同样的大小dongxiaoming
        bdiam = smallDiam * 3 / 2;
        wdiam = smallDiam * 3 / 2;
        ...
        g.fillOval(posX - strokeRadius + width / 2 - statusDiam / 2, posY + height * 7 / 26 + (diam - statusDiam) / 2, statusDiam, statusDiam);
        // }
        //    else {
        //    	bdiam=bdiam*4/3;
        //    	wdiam=wdiam*4/3;
        ...
        String bval = "", wval = "";
        if (isSmallCap)
            setPanelFont(g, (float) (min(width * 0.4, height * 0.85) * 0.2) > 18 ? 18 : (float) (min(width * 0.4, height * 0.85) * 0.2));
        ...
        if (!isSmallCap) {
            drawStringMid(g, posX + width / 4, posY + height * 28 / 32, uiFont, Font.PLAIN, Lizzie.resourceBundle.getString("LizzieFrame.captures") + bval, // 提子
                    height / 6, width * 3 / 10, 0);
            drawStringMid(g, posX + width * 3 / 4, posY + height * 28 / 32, uiFont, Font.PLAIN, Lizzie.resourceBundle.getString("LizzieFrame.captures") + wval, height / 6, width * 3 / 10, 0);

            if (analyzedBlack > 0)
                drawStringMid(g, posX + width / 4, posY + height * 19 / 32, uiFont, Font.PLAIN, Lizzie.resourceBundle.getString("LizzieFrame.AIscore") + bAiScore, // "AI总评分:"
                        height / 5, width * 4 / 10, 0);
            if (analyzedWhite > 0)
                drawStringMid(g, posX + width * 3 / 4, posY + height * 19 / 32, uiFont, Font.PLAIN, Lizzie.resourceBundle.getString("LizzieFrame.AIscore") + wAiScore, height / 5, width * 4 / 10, 0);
            //   drawString(g,wAiScore, posX + width * 3 / 4 + wx, posY + height * 7 / 8);
        } else {
            if (analyzedBlack > 0)
                drawStringMid(g, posX + width / 4, posY + height * 5 / 7, uiFont, Font.PLAIN, Lizzie.resourceBundle.getString("LizzieFrame.AIscore") + bAiScore, height * 2 / 5, width * 4 / 10, 0);
            if (analyzedWhite > 0)
                drawStringMid(g, posX + width * 3 / 4, posY + height * 5 / 7, uiFont, Font.PLAIN, Lizzie.resourceBundle.getString("LizzieFrame.AIscore") + wAiScore, height * 2 / 5, width * 4 / 10, 0);
        }
        // Komi
        if (isSmallCap)
            setPanelFont(g, (float) (min(width * 0.4, height * 0.85) * 0.2) > Config.frameFontSize + 6 ? Config.frameFontSize + 6 : Math.max((float) (min(width * 0.4, height * 0.85) * 0.2), 11f));
        ...
        if (isSmallCap) g.drawString(komi, posX - strokeRadius + width / 2 - kw / 2, posY + height * 15 / 16);
        ...
        if (EngineManager.isEngineGame && EngineManager.engineGameInfo.isGenmove)
            leela = Lizzie.board.getHistory().isBlacksTurn() ? Lizzie.engineManager.engineList.get(EngineManager.engineGameInfo.blackEngineIndex) : Lizzie.engineManager.engineList.get(EngineManager.engineGameInfo.whiteEngineIndex);
        ...
        if (leela.isKatago && !EngineManager.isEmpty) {
            ...
            if (usingSpecificRues) if (isSmallCap) {
        ...
        if (!shouldDrawMoveNumberDown()) {
            moveOrRules = String.valueOf(Lizzie.board.getHistory().getCurrentHistoryNode().getData().moveNumber);
            if (isSmallCap) {
                int mw = g.getFontMetrics().stringWidth(moveOrRules);
                g.drawString(moveOrRules, posX - strokeRadius + width / 2 - mw / 2, posY + height * 5 / 16);
            } else {
    ...
    private void drawWinratePane(int x, int y, int w, int h) {
        ...
        if (lastGrw != w || lastGrh != h || refreshWinratePane || !refreshFromInfo || (System.currentTimeMillis() - winratePaneTime) >= 200) {
    ...
    public boolean onClickedRight(int x, int y) {
        ...
        if (Lizzie.config.isThinkingMode()) {
            ...
            if (!boardCoordinates.isPresent()) boardCoordinates = boardRenderer.convertScreenToCoordinates(x, y);
        } else {
        ...
        if (boardCoordinates.isPresent()) {
            ...
            if (!isPlayingAgainstLeelaz && !isAnaPlayingAgainstLeelaz) {
                if (Lizzie.board.getHistory().getStones()[Board.getIndex(coords[0], coords[1])] != Stone.EMPTY) {
                    showmenu2(x, y, coords);
                } else {
    ...
    public void onClicked(int x, int y) {
        ...
        if (boardCoordinates.isPresent()) {
            ...
            if (!isPlayingAgainstLeelaz || (playerIsBlack == Lizzie.board.getData().blackToPlay)) {
                if (!isAnaPlayingAgainstLeelaz || !LizzieFrame.toolbar.chkAutoPlayBlack.isSelected() == Lizzie.board.getData().blackToPlay) {
                    if (isPlayingAgainstLeelaz || isAnaPlayingAgainstLeelaz) {
                        ...
                        if (allowPlaceStone && Lizzie.leelaz.isLoaded() && !EngineManager.isEmpty) {
                            ...
                            Utils.showMsg(Lizzie.resourceBundle.getString("LizzieFrame.waitEngineLoadingHint")); // ("请等待引擎加载完毕");
                        }
                        if (Lizzie.config.showrect == 1) {
        ...
        // }
        if (shouldShowSimpleVariation() && Lizzie.config.showVariationGraph && !EngineManager.isEngineGame) {
            variationTreeBig.onClicked(x, y);
        }
    }


    //点击落子LizzieFramedongxiaoming
    public void onClickedTrying(int x, int y) {
        Optional<int[]> boardCoordinates;
        boardCoordinates = boardRenderer.convertScreenToCoordinates(x, y);
        if (boardCoordinates.isPresent()) {
            int[] coords = boardCoordinates.get();
            Lizzie.board.placeTrying(coords[0], coords[1], false, false, false);
        }
    }
    ...
    private final Consumer<String> placeVariation = v -> Board.asCoordinates(v).ifPresent(c -> Lizzie.board.place(c[0], c[1]));
        ...
        if (Lizzie.config.showSuggestionVariations) {
            if (boardRenderer.getDisplayedBranchLength() > 0) {
                if (boardRenderer.variationOpt.isPresent()) {
                    for (int i = 0; i < Math.min(boardRenderer.variationOpt.get().size(), boardRenderer.getDisplayedBranchLength()); i++) {
    ...
    public boolean processSubOnMouseMoved(int x, int y) {
        if (Lizzie.config.isFourSubMode()) {
            if (x < subBoardLengthmouse && y < subBoardLengthmouse) {
                // 1
                if (!LizzieFrame.subBoardRenderer.isMouseOver && (EngineManager.isEmpty || !Lizzie.leelaz.isPondering()))
                    Lizzie.frame.refresh();
        ...
        if (Lizzie.config.showSubBoard) {
            // int x = e.getX()*3/2;
            //  int y = e.getY()*3/2;
            if (x >= subBoardXmouse && x <= subBoardXmouse + subBoardLengthmouse && y <= subBoardYmouse + subBoardLengthmouse && y >= subBoardYmouse) {
                if (!LizzieFrame.subBoardRenderer.isMouseOver && (EngineManager.isEmpty || !Lizzie.leelaz.isPondering()))
                    Lizzie.frame.refresh();
                LizzieFrame.subBoardRenderer.isMouseOver = true;
                return true;
    ...
    public void onMouseExited() {
        ...
        if (Lizzie.config.showMouseOverWinrateGraph && Lizzie.config.showWinrateGraph && winrateGraph.mouseOverNode != null) {
    ...
    public boolean shouldShowRect() {
        if (isInScoreMode) return false;
            ...
            return Lizzie.config.showrect == 0 || (Lizzie.config.showrect == 1 && (isPlayingAgainstLeelaz || isAnaPlayingAgainstLeelaz) && Lizzie.leelaz.isLoaded() && ((Lizzie.board.getHistory().isBlacksTurn() && Lizzie.frame.playerIsBlack) || (!Lizzie.board.getHistory().isBlacksTurn() && !Lizzie.frame.playerIsBlack)));
    }
    ...
    public List<MoveData> getBestMoves() {
        ...
        if (EngineManager.isEngineGame && Lizzie.config.showPreviousBestmovesInEngineGame) {
            if (Lizzie.board.getHistory().getCurrentHistoryNode().previous().isPresent())
                bestMoves = Lizzie.board.getHistory().getCurrentHistoryNode().previous().get().getData().bestMoves;
    ...
    public boolean onMouseMoved(int x, int y) {
        if (Lizzie.config.showMouseOverWinrateGraph && Lizzie.config.showWinrateGraph && processMouseMoveOnWinrateGraph(x, y))
            return false;
        if (Lizzie.config.showMouseOverWinrateGraph && Lizzie.config.showWinrateGraph && winrateGraph.mouseOverNode != null) {
            winrateGraph.clearMouseOverNode();
            ...
            if (isCoordsChanged) {
                ...
                if (Lizzie.config.showNextMoveBlunder) {
                    if (Lizzie.board.getHistory().getCurrentHistoryNode().next().isPresent()) {
                        ...
                        if (nextData.getPlayouts() > 0) if (nextData.lastMove.isPresent())
                            if (nextData.lastMove.get()[0] == curCoords[0] && nextData.lastMove.get()[1] == curCoords[1]) {
                                isCurMouseOver = true;
                            }
                    }
                }
                List<MoveData> bestMoves = getBestMoves();
                if (!bestMoves.isEmpty()) for (int i = 0; i < bestMoves.size(); i++) {
                ...
                if (Lizzie.config.isDoubleEngineMode()) {
                    List<MoveData> bestMoves2 = Lizzie.board.getHistory().getCurrentHistoryNode().getData().bestMoves2;
                    if (!bestMoves2.isEmpty()) for (int i = 0; i < bestMoves2.size(); i++) {
            ...
            if (shouldShowRect()) {
                ...
                if (Lizzie.config.isDoubleEngineMode()) {
                    ...
                    if (coords2.isPresent()) {
                        boardRenderer2.drawmoveblock(curCoords[0], curCoords[1], Lizzie.board.getHistory().isBlacksTurn());
                    } else
                        boardRenderer.drawmoveblock(curCoords[0], curCoords[1], Lizzie.board.getHistory().isBlacksTurn());
                } else
                    boardRenderer.drawmoveblock(curCoords[0], curCoords[1], Lizzie.board.getHistory().isBlacksTurn());
    ...
    public boolean isMouseOver(int x, int y) {
        if ((Lizzie.board.getHistory().isBlacksTurn() && !Lizzie.config.showBlackCandidates) || (!Lizzie.board.getHistory().isBlacksTurn() && !Lizzie.config.showWhiteCandidates)) {
            return false;
        }
        if (Lizzie.config.showSuggestionVariations) return mouseOverCoordinate[0] == x && mouseOverCoordinate[1] == y;
        else return false;
    }
    ...
    public boolean isMouseOverIndependMainBoard(int x, int y) {
        ...
        if (Lizzie.config.showSuggestionVariations)
            return independentMainBoard.mouseOverCoordinate[0] == x && independentMainBoard.mouseOverCoordinate[1] == y;
        else return false;
    }
    ...
    public boolean isInPlayMode() {
        return Lizzie.config.UsePlayMode && (isPlayingAgainstLeelaz || isAnaPlayingAgainstLeelaz) && !syncBoard;
    }
    ...
    public boolean processPressOnSub(MouseEvent e) {
        if (isInPlayMode() || Lizzie.config.isThinkingMode()) {
            return false;
        }
        if (Lizzie.config.isFourSubMode()) {
            ...
            } else if (x >= subBoardLengthmouse / 2 && x < subBoardLengthmouse && y < subBoardLengthmouse / 2) {
                // 2
                if (e.getButton() == MouseEvent.BUTTON1) {
            ...
            } else if (x < subBoardLengthmouse / 2 && y < subBoardLengthmouse && y >= subBoardLengthmouse / 2) {
                // 3
                if (e.getButton() == MouseEvent.BUTTON1) {
            ...
            } else if (x >= subBoardLengthmouse / 2 && x < subBoardLengthmouse && y < subBoardLengthmouse && y >= subBoardLengthmouse / 2) {
                // 4
                if (e.getButton() == MouseEvent.BUTTON1) {
    ...
    private void setComment(boolean needReaddText) {
        ...
        if (((Lizzie.leelaz != null && !Lizzie.leelaz.isLoaded()) || (EngineManager.isPreEngineGame && (!Lizzie.engineManager.engineList.get(EngineManager.engineGameInfo.whiteEngineIndex).isLoaded() || !Lizzie.engineManager.engineList.get(EngineManager.engineGameInfo.blackEngineIndex).isLoaded()))))
            isLoadingEngine = true;
        if (isLoadingEngine) {
            if ((Lizzie.leelaz != null && Lizzie.leelaz.isTuning) || (EngineManager.isPreEngineGame && (!Lizzie.engineManager.engineList.get(EngineManager.engineGameInfo.whiteEngineIndex).isTuning || !Lizzie.engineManager.engineList.get(EngineManager.engineGameInfo.blackEngineIndex).isTuning))) {
                isTuningEngine = true;
            }
        }
        String comment = "";
        if (!isInPlayMode()) {
            if (isLoadingEngine) {
                commentScrollPane.getVerticalScrollBar().setValue(commentScrollPane.getVerticalScrollBar().getMaximum());
            }
            if (isLoadingEngine) {
                if (Lizzie.gtpConsole != null) {
        ...
        if (Lizzie.config.commentFontSize <= 0) {
            int fontSize;
            if (Lizzie.config.showLargeSubBoard() || Lizzie.config.showLargeWinrate()) {
                fontSize = (int) (min((getWidth() > 1.75 * getHeight() ? 1.75 * getHeight() : getWidth()) * 0.43, getHeight()) * 0.0225);
            ...
            if (isCommentArea) {
                if (commentFontSize != fontSize) {
                    ...
                    if (isCommentArea) {
                        ...
                        commentEditTextPane.setFont(new Font(Lizzie.config.uiFontName, Font.PLAIN, commentFontSize));
                    }
                }
            } else {
                if (commentPaneFontSize != fontSize) {
                    commentPaneFontSize = fontSize;
                    String style = "body {background:" + String.format("%02x%02x%02x", Lizzie.config.commentBackgroundColor.getRed(), Lizzie.config.commentBackgroundColor.getGreen(), Lizzie.config.commentBackgroundColor.getBlue()) + "; color:#" + String.format("%02x%02x%02x", Lizzie.config.commentFontColor.getRed(), Lizzie.config.commentFontColor.getGreen(), Lizzie.config.commentFontColor.getBlue()) + "; font-family:" + Lizzie.config.uiFontName + ", Consolas, Menlo, Monaco, 'Ubuntu Mono', monospace;" + (commentPaneFontSize > 0 ? "font-size:" + commentPaneFontSize : "") + "}";
                    htmlStyle.addRule(style);
                }
            }
        }
        ...
        try {
            // if (isLoadingEngine) {
            if (!cachedComment.equals(comment) || needReaddText && isCommentArea) {
                ...
                if (Lizzie.config.appendWinrateToComment || EngineManager.isEngineGame) {
                    ...
                    if (autoIntervalCom > 0 && currentTime - lastAutocomTime >= autoIntervalCom) {
                        ...
                        if (Lizzie.leelaz != null && !Lizzie.board.isLoadingFile) {
                            ...
                            //     }
                            if (!Lizzie.leelaz.isPondering() && !isPlayingAgainstLeelaz && !EngineManager.isEngineGame && !(Lizzie.board.getHistory().getData().comment).equals(comment))
                                refresh();
                        }
                    }
                }
    ...
    public void setPlayers(String whitePlayer, String blackPlayer) {
        playerTitle = String.format("- [" + Lizzie.resourceBundle.getString("Menu.Black") + "]%s vs[" + Lizzie.resourceBundle.getString("Menu.White") + "]%s", blackPlayer, whitePlayer);
        //  updateTitle();
    }

    public void setResult(String result) {
        if (result.equals("")) resultTitle = "";
        else resultTitle = String.format("(" + Lizzie.resourceBundle.getString("LizzieFrame.result") + "%s)", result);
        //  updateTitle();
    }
    ...
    public void updateTitle() {
        ...
        if ((EngineManager.isEngineGame && EngineManager.engineGameInfo.isGenmove)) {
            ...
            sb.append((Lizzie.board.getHistory().getData().blackToPlay ? Lizzie.engineManager.engineList.get(EngineManager.engineGameInfo.blackEngineIndex).oriEnginename : Lizzie.engineManager.engineList.get(EngineManager.engineGameInfo.whiteEngineIndex).oriEnginename) + " " + Lizzie.resourceBundle.getString("LizzieFrame.thinking"));
        ...
        if (Lizzie.config.showTitleWr && (!(isPlayingAgainstLeelaz || isAnaPlayingAgainstLeelaz) || (syncBoard || !isInPlayMode()))) {
            ...
            if (Lizzie.board.getHistory().getData().getPlayouts() > 0) {
                ...
                if (!Lizzie.board.getHistory().isBlacksTurn()) {
                    winRateC = 100 - winRateC;
                }
                winRate = winRateC > -100 && winRateC < 100 ? winRateC : winRate;
                sb.append(String.format(Locale.ENGLISH, "%.1f", winRate) + " " + Utils.getPlayoutsString(Lizzie.board.getHistory().getData().getPlayouts()));
                ...
                sb.append("] ");
            } else if (Lizzie.board.getHistory().getCurrentHistoryNode().previous().isPresent() && Lizzie.board.getHistory().getCurrentHistoryNode().previous().get().getData().getPlayouts() > 0) {
                sb.append("[");
                BoardData data = Lizzie.board.getHistory().getCurrentHistoryNode().previous().get().getData();
                sb.append(String.format(Locale.ENGLISH, "%.1f", 100 - data.winrate) + " " + Utils.getPlayoutsString(data.getPlayouts()));
                if (data.isKataData) {
    ...
    public void pasteSgf() {
        ...
        String sgfContent = Optional.ofNullable(Toolkit.getDefaultToolkit().getSystemClipboard().getContents(null)).filter(cc -> cc.isDataFlavorSupported(DataFlavor.stringFlavor)).flatMap(cc -> {
            try {
    ...
    private void drawComment(Graphics2D g, int x, int y, int w, int h) {
        ...
        h = Utils.zoomIn(h);
        if (Lizzie.config.isShowingBlunderTabel) {
            if (x != blunderContentPane.getX() || y + (Lizzie.config.showDoubleMenu ? topPanelHeight : 0) != blunderContentPane.getY() || w != blunderContentPane.getWidth() || h != blunderContentPane.getHeight()) {
                {
                    blunderContentPane.setBounds(x, y + (Lizzie.config.showDoubleMenu ? topPanelHeight : 0), w, h);
                    blunderContentPane.revalidate();
                }
            }
        } else {
            if (x != commentScrollPane.getX() || y + (Lizzie.config.showDoubleMenu ? topPanelHeight : 0) != commentScrollPane.getY() || w != commentScrollPane.getWidth() || h != commentScrollPane.getHeight()) {
                commentScrollPane.setBounds(x, y + (Lizzie.config.showDoubleMenu ? topPanelHeight : 0), w, h);
    ...
    public void resetCommentComponent() {
        commentTextPane.setForeground(Lizzie.config.commentFontColor);
        commentTextPane.setBackground(Lizzie.config.commentBackgroundColor);
        String style = "body {background:" + String.format("%02x%02x%02x", Lizzie.config.commentBackgroundColor.getRed(), Lizzie.config.commentBackgroundColor.getGreen(), Lizzie.config.commentBackgroundColor.getBlue()) + "; color:#" + String.format("%02x%02x%02x", Lizzie.config.commentFontColor.getRed(), Lizzie.config.commentFontColor.getGreen(), Lizzie.config.commentFontColor.getBlue()) + "; font-family:" + Lizzie.config.uiFontName + ", Consolas, Menlo, Monaco, 'Ubuntu Mono', monospace;" + (Lizzie.config.commentFontSize > 0 ? Lizzie.config.commentFontSize : commentFontSize > 0 ? commentFontSize : Config.frameFontSize) + "}";
        htmlStyle.addRule(style);
        commentTextArea.setFont(new Font(Lizzie.config.uiFontName, Font.PLAIN, Lizzie.config.commentFontSize > 0 ? Lizzie.config.commentFontSize : commentFontSize > 0 ? commentFontSize : Config.frameFontSize));
        commentTextArea.setForeground(Lizzie.config.commentFontColor);
        commentTextArea.setBackground(Lizzie.config.commentBackgroundColor);
        commentScrollPane.setBackground(Lizzie.config.commentBackgroundColor);
    }
    ...
    private void JlabelSetText(JLabel jLabel, String longString, int width, int maxHeight) throws InterruptedException {
        int lines = 0;
    ...
    public Color getBlunderNodeColor(BoardHistoryNode node) {
        if (EngineManager.isEngineGame || Lizzie.board.isPkBoard || Lizzie.frame.isContributing) {
            if (node.previous().isPresent() && node.previous().get().previous().isPresent()) {
                if (node.previous().get().previous().get().getData().getPlayouts() == 0 || node.getData().getPlayouts() == 0)
                    return Color.WHITE;
                double diffWinrate = node.getData().getWinrate() - node.previous().get().previous().get().getData().getWinrate();
                Optional<Double> st;
                if (node.getData().isKataData && Lizzie.config.useScoreDiffInVariationTree) {
                    double diffSocre = node.getData().scoreMean - node.previous().get().previous().get().getData().scoreMean;
                    st = Lizzie.config.blunderWinrateThresholds.flatMap(l -> l.stream().filter(t -> (t >= Math.min(diffWinrate, diffSocre * (1.0 / Lizzie.config.scoreDiffInVariationTreeFactor)))).reduce((f, s) -> f));
                } else {
                    st = Lizzie.config.blunderWinrateThresholds.flatMap(l -> l.stream().filter(t -> (t >= diffWinrate)).reduce((f, s) -> f));
                }
                //            diffWinrate >= 0
        ...
        if (Lizzie.config.useScoreDiffInVariationTree)
            st = Lizzie.config.blunderWinrateThresholds.flatMap(l -> l.stream().filter(t -> (t >= Math.min(diff[0], diff[1] * (1.0 / Lizzie.config.scoreDiffInVariationTreeFactor)))).reduce((f, s) -> f));
        else
            st = Lizzie.config.blunderWinrateThresholds.flatMap(l -> l.stream().filter(t -> (t >= diff[0])).reduce((f, s) -> f));
        if (st.isPresent()) {
            return Lizzie.config.blunderNodeColors.map(m -> m.get(st.get())).get();
        } else {
            return Color.WHITE;
    ...
    public void replayBranch() {
        ...
        if (!Lizzie.config.noRefreshOnMouseMove && Lizzie.leelaz.isPondering()) Lizzie.leelaz.togglePonder();
        Runnable runnable = new Runnable() {
            public void run() {
    ...
    public void DraggedReleased(int x, int y, BoardRenderer boardRenderer, Stone draggedstone, boolean Draggedmode, int[] draggedCoords) {
        GameInfo gameInfo = Lizzie.board.getHistory().getGameInfo();
        boardRenderer.removedrawmovestone();
        Optional<int[]> boardCoordinates = boardRenderer.convertScreenToCoordinates(x, y);
        if (boardCoordinates.isPresent()) {
            ...
            if (coords[0] == startcoords[0] && coords[1] == startcoords[1]) {
                ...
                if (moveNumber > 0) {
                    MoveLinkedList reStoreMainListHead = Lizzie.board.getMainMoveLinkedListBetween(Lizzie.board.getBoardHistoryNodeByCoords(draggedCoords), Lizzie.board.getHistory().getCurrentHistoryNode());
                    ...
                    int index = Lizzie.board.getHistory().getCurrentHistoryNode().previous().isPresent() ? Lizzie.board.getHistory().getCurrentHistoryNode().previous().get().findIndexOfNode(Lizzie.board.getHistory().getCurrentHistoryNode()) : -1;
                    MoveLinkedList listHead = Lizzie.board.getMoveLinkedListAfter(Lizzie.board.getHistory().getCurrentHistoryNode());
                    if (listHead == null) {
                    ...
                    MoveLinkedList reStoreMainListHead = Lizzie.board.getMainMoveLinkedListBetween(Lizzie.board.getHistory().getStart(), Lizzie.board.getHistory().getCurrentHistoryNode());
                    if (reStoreMainListHead != null) {
                        while (reStoreMainListHead.variations.size() > 0)
                            reStoreMainListHead = reStoreMainListHead.variations.get(0);
                    ...
                    if (listHead == null) {
                        ...
                        boolean blackToPlay = Lizzie.board.getHistory().getStart().getData().blackToPlay;
                        if (Lizzie.board.hasStartStone) startMoveNumber += Lizzie.board.startStonelist.size();
                        Lizzie.board.editmovelist(Lizzie.board.tempallmovelist, draggedCoords, coords[0], coords[1]);
                        Lizzie.board.clearforedit();
                        Lizzie.board.setMoveListWithFlattenExit(Lizzie.board.tempallmovelist, startMoveNumber, blackToPlay);
                    } else {
                        int startMoveNumber = 0;
                        boolean blackToPlay = Lizzie.board.getHistory().getStart().getData().blackToPlay;
                        if (Lizzie.board.hasStartStone) startMoveNumber += Lizzie.board.startStonelist.size();
    ...
    public void selectDragged(int x, int y) {
        if (selectX1 > 0 && selectY1 > 0) boardRenderer.drawSelectedRect(selectX1, selectY1, x, y, selectForceAllow);
    ...
    public void selectReleased(int x, int y) {
        if (selectX1 > 0 && selectY1 > 0) {
            Optional<int[]> boardCoordinates = boardRenderer.convertScreenToCoordinatesForSelect(min(selectX1, x), max(selectX1, x), min(selectY1, y), max(selectY1, y));
            if (boardCoordinates.isPresent()) {
                //     selectX2 = x;
                //     selectY2 = y;
                int[] coords = boardCoordinates.get();
    ...
    public void togglePolicy() {
        ...
        if (!isShowingPolicy) {
            ...
            // }
            //
            if (!Lizzie.leelaz.isPondering() && Lizzie.board.getData().bestMoves.isEmpty()) Lizzie.leelaz.ponder();
        } else {
            isShowingPolicy = false;
    ...
    public void doBranchSub(int subOrder, int moveTo) {
        ...
        if (subBoardRendererThis.isShowingNormalBoard()) {
            ...
            {
                if (subBoardRendererThis.getReplayBranch() > subBoardRendererThis.getDisplayedBranchLength()) {
    ...
    public void saveImage() {
        Runnable runnable = new Runnable() {
            public void run() {
                try {
                    JSONObject filesystem = Lizzie.config.persisted.getJSONObject("filesystem");
                    JFileChooser chooser = new JFileChooser(filesystem.optString("last-image-folder", filesystem.getString("last-folder")));
                    ...
                    if (result == JFileChooser.APPROVE_OPTION) {
                        ...
                        String ext = chooser.getFileFilter() instanceof FileNameExtensionFilter ? ((FileNameExtensionFilter) chooser.getFileFilter()).getExtensions()[0].toLowerCase() : "";
                        ...
                        if (file.exists()) {
                            int ret = JOptionPane.showConfirmDialog(Lizzie.frame, Lizzie.resourceBundle.getString("LizzieFrame.fileExists"), Lizzie.resourceBundle.getString("LizzieFrame.warning"), JOptionPane.OK_CANCEL_OPTION);
                            if (ret == JOptionPane.CANCEL_OPTION || ret == -1) {
                                return;
                            }
                        }
                        ...
                        try {
                            ...
                            if (!supported) {
                                String displayedMessage = String.format(Lizzie.resourceBundle.getString("LizzieFrame.saveImageErrorHint1") + " \"%s\"\n(" + Lizzie.resourceBundle.getString("LizzieFrame.saveImageErrorHint2") + ")", file.getName());
                                JOptionPane.showMessageDialog(Lizzie.frame, displayedMessage, Lizzie.resourceBundle.getString("LizzieFrame.lizzieError"), JOptionPane.ERROR_MESSAGE);
                            }
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
    ...
    public void saveMainBoardPicture() {
        if (Lizzie.config.isFloatBoardMode()) saveImageToFile(getIndependMainBoardToClipboard());
            ...
            saveImage(Lizzie.frame.boardX, Lizzie.frame.boardY, Lizzie.frame.maxSize, Lizzie.frame.maxSize);
        }
    }
    ...
    public void saveSubBoardPicture() {
        if (independentSubBoard != null && this.independentSubBoard.isVisible()) {
            ...
            saveImage(subBoardRenderer.x, subBoardRenderer.y, subBoardRenderer.boardWidth, subBoardRenderer.boardHeight);
        else {
            ...
            public void run() {
                try {
                    ...
                    if (result == JFileChooser.APPROVE_OPTION) {
                        ...
                        buffImg.getGraphics().drawImage(areaImage.getScaledInstance(width, height, java.awt.Image.SCALE_SMOOTH), 0, 0, null);
                        try {
    ...
    private void drawString(Graphics2D g, int x, int y, Font fontBase, int style, String string, float maximumFontHeight, double maximumFontWidth, int aboveOrBelow, boolean middle) {
        ...
        if (font.getSize() > Math.round(Config.frameFontSize * Lizzie.javaScaleFactor) + 4) {
            font = new Font(font.getName(), font.getStyle(), Math.round(Config.frameFontSize * Lizzie.javaScaleFactor) + 4);
        }
        g.setFont(font);
        ...
        g.drawString(string, middle ? x + (int) (maximumFontWidth - length) / 2 : x, y + height / 2 + verticalOffset);
    }

    private void drawStringMid(Graphics2D g, int x, int y, Font fontBase, int style, String string, float maximumFontHeight, double maximumFontWidth, int aboveOrBelow) {
        ...
        if (font.getSize() > Math.round(Config.frameFontSize * Lizzie.javaScaleFactor) + 6) {
            font = new Font(font.getName(), font.getStyle(), Math.round(Config.frameFontSize * Lizzie.javaScaleFactor) + 6);
        }
        g.setFont(font);
        fm = g.getFontMetrics(font);
    ...
    public void saveMainBoardToClipboard() {
        ...
        else savePicToClipboard(Lizzie.frame.boardX, Lizzie.frame.boardY, Lizzie.frame.maxSize, Lizzie.frame.maxSize);
    }
    ...
    private void saveIndependMainBoardToClipboard() {
        if (Config.isScaled) {
            ...
            BufferedImage areaImage = this.independentMainBoard.cachedImage.getSubimage(rect.x, rect.y, rect.width, rect.height);
            BufferedImage buffImg = new BufferedImage(width, height, BufferedImage.TYPE_INT_RGB);
            buffImg.getGraphics().drawImage(areaImage.getScaledInstance(width, height, java.awt.Image.SCALE_SMOOTH), 0, 0, null);
    ...
    public void savePicToClipboard(int x, int y, int width, int height) {
        if (Config.isScaled) {
            ...
            BufferedImage bImg = new BufferedImage(this.mainPanel.getWidth(), this.mainPanel.getHeight(), BufferedImage.TYPE_INT_ARGB);
            Graphics2D cg = bImg.createGraphics();
    ...
    public void openHelp() {
        ...
        String url = courseFile + File.separator + Lizzie.resourceBundle.getString("Menu.introduction.fileName");
        ...
        timer = new javax.swing.Timer(500, new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
                ...
                if (moveNumber > maxMvNum || (firstSync && moveNumber > 0)) {
                    SwingUtilities.invokeLater(new Thread() {
                        public void run() {
                            if (((Lizzie.board.getHistory().getCurrentHistoryNode().isMainTrunk() && Lizzie.board.getHistory().getCurrentHistoryNode().getData().moveNumber == maxMvNum) || firstSync) || Lizzie.config.alwaysGotoLastOnLive) {
                                moveToMainTrunk();
                                Lizzie.board.goToMoveNumberBeyondBranch(moveNumber);
                                if (firstSync) {
                                    renderVarTree(0, 0, false, false);
            ...
            public void run() {
                ...
                if (!success) {
                    if (setkatarules.isVisible())
                        JOptionPane.showMessageDialog(setkatarules, Lizzie.resourceBundle.getString("LizzieFrame.ruleWarning"));
                }
            }
        };
        Thread thread = new Thread(runnable);
    ...
    public void startEngineGameDialog() {
        if (EngineManager.isEngineGame) {
            Utils.showMsg(Lizzie.resourceBundle.getString("LizzieFrame.engineGameStopFirstHint")); // "请等待当前引擎对战结束,或手动终止对局");
            return;
        }
    ...
    public void continueAiPlaying(boolean isGenmove, boolean continueNow, boolean playerIsB, boolean fromShortCut) {
        if (Lizzie.frame.isContributing) {
            Utils.showMsg(Lizzie.resourceBundle.getString("Contribute.tips.contributingAndStartAnotherLizzieYzy"));
            return;
        }
        ...
        if (isGenmove) {
            ...
            if (!toolbar.chkAutoPlayTime.isSelected() && !toolbar.chkAutoPlayFirstPlayouts.isSelected() && !toolbar.chkAutoPlayPlayouts.isSelected()) {
                toolbar.txtAutoPlayTime.setText(String.valueOf(Math.max(1, Lizzie.config.maxGameThinkingTimeSeconds)));
            ...
            if (Lizzie.config.UsePureNetInGame && !Lizzie.leelaz.isheatmap) Lizzie.leelaz.toggleHeatmap(false);
            Lizzie.leelaz.ponder();
        }
...
//      Utils.showMsg(Lizzie.resourceBundle.getString("LizzieFrame.startContinueGame"));
    ...
    private void setListScrollpane(int vx, int vy, int vw, int vh) {
        ...
        if (listScrollpane.getX() != vx || listScrollpane.getY() != vy + (Lizzie.config.showDoubleMenu ? topPanelHeight : 0) || listScrollpane.getWidth() != vw || listScrollpane.getHeight() != vh)
            listScrollpane.setBounds(Utils.zoomIn(vx), Utils.zoomIn(vy) + (Lizzie.config.showDoubleMenu ? topPanelHeight : 0), Utils.zoomIn(vw), Utils.zoomIn(vh));
    }
    ...
    private boolean shouldShowSimpleVariation() {
        return (!Lizzie.config.ignoreOutOfWidth && Lizzie.board.hasBigBranch()) || !Lizzie.config.showScrollVariation;
    }
    ...
    private void createVarTreeImage(int vx, int vy, int vw, int vh, Graphics2D g) {
        ...
        Runnable runnable = new Runnable() {
            public void run() {
                try {
                    ...
                    varTreePane.setPreferredSize(new Dimension((int) (cachedVarImage2.getWidth() / Lizzie.javaScaleFactor), (int) (cachedVarImage2.getHeight() / Lizzie.javaScaleFactor)));
                    varTreePane.updateUI();
                    varTreeScrollPane.setBounds(Utils.zoomIn(vx), Utils.zoomIn(vy) + (Lizzie.config.showDoubleMenu ? topPanelHeight : 0), Utils.zoomIn(vw), Utils.zoomIn(vh));
        ...
        if (vh < 100 || varTreeMaxX == vw)
            varTreeScrollPane.setHorizontalScrollBarPolicy(ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
    ...
    public void renderVarTreeCur() {
        ...
        if (Lizzie.config.showCommentNodeColor && !cur.getData().comment.isEmpty()) {
            ...
            g.fillOval(tree_curposx + (tree_DOT_DIAM + tree_diff - tree_RING_DIAM) / 2, tree_posy + (tree_DOT_DIAM + tree_diff - tree_RING_DIAM) / 2, tree_RING_DIAM, tree_RING_DIAM);
            g.setColor(new Color(0, 0, 0, 130));
            g.fillOval(tree_curposx + (tree_DOT_DIAM + tree_diff - tree_RING_DIAM) / 2, tree_posy + (tree_DOT_DIAM + tree_diff - tree_RING_DIAM) / 2, tree_RING_DIAM, tree_RING_DIAM);
            ...
            g.fillOval(tree_curposx + tree_diff - 1, tree_posy + tree_diff - 1, tree_diam + 2, tree_diam + 2);
            g.setColor(new Color(0, 0, 0, 130));
            g.fillOval(tree_curposx + tree_diff - 1, tree_posy + tree_diff - 1, tree_diam + 2, tree_diam + 2);
        }
        ...
        g.setColor(Color.BLACK);
        g.fillOval(tree_curposx + (tree_DOT_DIAM + tree_diff - tree_CENTER_DIAM) / 2, tree_posy + (tree_DOT_DIAM + tree_diff - tree_CENTER_DIAM) / 2, tree_CENTER_DIAM, tree_CENTER_DIAM);
        g.dispose();
    }
    ...
    public void renderVarTree(int vw, int vh, boolean changeSize, boolean needGetEnd) {
        ...
        Runnable runnable = new Runnable() {
            public void run() {
                ...
                if (varTreeCurX <= varTreeW / 2 || Lizzie.board.getHistory().getCurrentHistoryNode() == Lizzie.board.getHistory().getStart())
                    jScrollBarW.setValue(0);
                else {
                    jScrollBarW.setValue((int) ((((varTreeCurX - varTreeW / 2f) / varTreeMaxX) * jScrollBarW.getMaximum())));
                }
                ...
                if (needGetEnd) {
                    ...
                    if (varTreeCurY <= varTreeH / 2 || Lizzie.board.getHistory().getCurrentHistoryNode() == Lizzie.board.getHistory().getStart()) // 129,155
                        jScrollBarH.setValue(0);
                    else
                        jScrollBarH.setValue((int) ((((varTreeCurY - varTreeH / 2f) / varTreeMaxY) * jScrollBarH.getMaximum()))); // 设置垂直滚动条位置
                }
                if (changeSize) {
                    if (vh < 100 || varTreeMaxX == vw)
                        varTreeScrollPane.setHorizontalScrollBarPolicy(ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
                ...
                if (varTreeMaxY == vh)
                    varTreeScrollPane.setVerticalScrollBarPolicy(ScrollPaneConstants.VERTICAL_SCROLLBAR_NEVER);
                else varTreeScrollPane.setVerticalScrollBarPolicy(ScrollPaneConstants.VERTICAL_SCROLLBAR_AS_NEEDED);
                completeDrawTree = true;
            }
        };
        Thread thread = new Thread(runnable);
...
//        }
    ...
    public void drawKataEstimate(Leelaz engine, ArrayList<Double> tempcount) {
        ...
        if ((Lizzie.leelaz.iskataHeatmapShowOwner && Lizzie.config.showPureEstimateBySize)) {
            if (Lizzie.config.isDoubleEngineMode()) {
                if (engine == Lizzie.leelaz) LizzieFrame.boardRenderer.drawKataEstimateBySize(tempcount, false);
            ...
            if (!Lizzie.config.isDoubleEngineMode()) {
                if (Lizzie.config.showSubBoard) LizzieFrame.subBoardRenderer.drawKataEstimateBySize(tempcount, false);
            ...
            if (!Lizzie.config.isDoubleEngineMode()) {
                ...
                if (independentSubBoard != null && independentSubBoard.isVisible())
                    independentSubBoard.subBoardRenderer.drawKataEstimateByTransparent(tempcount, false, true);
            }
        }
    }
        ...
        new Thread() {
            public void run() {
                ...
                if (fileName.equals("")) {
                    ...
                    fileName = new SimpleDateFormat("yyyy-MM-dd-HH-mmss").format(new Date()) + "(" + fileName + ")";
                }
                File file = new File("");
                String courseFile = "";
                try {
                ...
                File autoSaveFile;
                autoSaveFile = new File(courseFile + File.separator + "MyGames" + File.separator + fileName + ".sgf");
    ...
    public void reSetLoc() {
        SwingUtilities.invokeLater(new Thread() {
            public void run() {
                ...
                mainPanel.setBounds(0, (Lizzie.config.showDoubleMenu ? topPanelHeight : 0), Utils.zoomOut(width), Utils.zoomOut(Lizzie.frame.getHeight() - Lizzie.frame.getJMenuBar().getHeight() - Lizzie.frame.getInsets().top - Lizzie.frame.getInsets().bottom - toolbarHeight - (Lizzie.config.showDoubleMenu ? topPanelHeight : 0)));
                toolbar.setBounds(0, Lizzie.frame.getHeight() - Lizzie.frame.getJMenuBar().getHeight() - Lizzie.frame.getInsets().top - Lizzie.frame.getInsets().bottom - toolbarHeight, width, toolbarHeight);
                if (toolbar.showDetail) {
                    toolbar.setDetailIcon();
                }
    ...
    private void saveIndependSubBoardToClipboard() {
        if (Config.isScaled) {
            ...
            Rectangle rect = new Rectangle(0, 0, width, height);
            BufferedImage areaImage = this.independentSubBoard.cachedImage.getSubimage(rect.x, rect.y, rect.width, rect.height);
            BufferedImage buffImg = new BufferedImage(width, height, BufferedImage.TYPE_INT_RGB);
            buffImg.getGraphics().drawImage(areaImage.getScaledInstance(width, height, java.awt.Image.SCALE_SMOOTH), 0, 0, null);
            setClipboardImage(buffImg);
        } else {
    ...
    public void copySubBoard() {
        if (independentSubBoard != null && independentSubBoard.isVisible()) {
            ...
            savePicToClipboard(subBoardRenderer.x, subBoardRenderer.y, subBoardRenderer.boardWidth, subBoardRenderer.boardHeight);
        }
    }
    ...
    public void setMouseOverCoords(int index) {
        ...
        mouseOverCoordinate = Board.convertNameToCoordinates(Lizzie.board.getHistory().getData().bestMoves.get(index).coordinate);
    }
    ...
    private void handleTableClick(int row, int col) {
        ...
        if (clickOrder != -1 && selectedorder >= 0 && Board.convertNameToCoordinates(listTable.getValueAt(row, 1).toString())[0] == Lizzie.frame.suggestionclick[0] && Board.convertNameToCoordinates(listTable.getValueAt(row, 1).toString())[1] == Lizzie.frame.suggestionclick[1]) {
            Lizzie.frame.suggestionclick = LizzieFrame.outOfBoundCoordinate;
            Lizzie.frame.mouseOverCoordinate = LizzieFrame.outOfBoundCoordinate;
    ...
    public AbstractTableModel getTableModel() {
        ...
        return new AbstractTableModel() {
            ...
            public int getRowCount() {
                ...
                if (bestMoves != null) for (int i = 0; i < bestMoves.size(); i++) {
                    ...
                    if (Lizzie.board.getHistory().getCurrentHistoryNode().next().isPresent()) {
                        ...
                        if (next.getData().lastMove.isPresent()) {
                            ...
                            for (MoveData move : data2) {
                                if (Board.convertNameToCoordinates(move.coordinate)[0] == coords[0] && Board.convertNameToCoordinates(move.coordinate)[1] == coords[1]) {
                                    if (move.order == 0) {
            ...
            public String getColumnName(int column) {
                ...
                if (column == 2) return Lizzie.resourceBundle.getString("LizzieFrame.listColumn2"); // "胜率(%)";
                if (column == 3) return Lizzie.resourceBundle.getString("AnalysisFrame.column5"); // "计算量";
                if (column == 4) return Lizzie.resourceBundle.getString("LizzieFrame.listColumn4"); // "占比(%)";
                ...
                switch (col) {
                    case 0:
                        if (data.order == -100)
                            ...
                            return data.order + 1 + "(" + Lizzie.resourceBundle.getString("AnalysisFrame.actual") + ")";
                    ...
                    case 2:
                        if (data.isNextMove) {
                            if (data.order != 0) {
                                ...
                                return (diff > 0 ? "↑" : "↓") + String.format(Locale.ENGLISH, "%.1f", diff) + "(" + String.format("%.1f", Lizzie.config.winrateAlwaysBlack ? (Lizzie.board.getHistory().isBlacksTurn() ? data.winrate : 100 - data.winrate) : data.winrate) + ")";
                            }
                        }
                        return String.format("%.1f", Lizzie.config.winrateAlwaysBlack ? (Lizzie.board.getHistory().isBlacksTurn() ? data.winrate : 100 - data.winrate) : data.winrate);
                    case 3:
                        return Utils.getPlayoutsString(data.playouts);
                    case 4:
                        return String.format(Locale.ENGLISH, "%.1f", (double) data.playouts * 100 / totalPlayouts);
                    case 5:
                        ...
                        if (data.isNextMove && data.order != 0) {
                            ...
                            return (diff > 0 ? "↑" : "↓") + String.format(Locale.ENGLISH, "%.1f", diff) + "(" + String.format(Locale.ENGLISH, "%.1f", score) + ")";
    ...
    class ColorTableCellRenderer extends DefaultTableCellRenderer {
        ...
        public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
            ...
            if (move.length() > 3 && !move.toLowerCase().equals("pass")) {
                ...
                if (winrate.contains("(")) diff = Double.parseDouble(winrate.substring(1, winrate.indexOf("(")));
                else diff = 0;
                String score = table.getValueAt(row, 5).toString();
                if (score.contains("(")) scoreDiff = Double.parseDouble(score.substring(1, score.indexOf("(")));
                else scoreDiff = 0;
            ...
            if (coords[0] == Lizzie.frame.suggestionclick[0] && coords[1] == Lizzie.frame.suggestionclick[1]) {
        ...
        public void paintComponent(Graphics g) {
            if (isPlayoutPercents) {
                ...
                g2.fillRect(0, 0, (int) (getWidth() * (Double.parseDouble(mainValue.toString()) / 100)), getHeight());
                ...
                if (isNextMove) {
                    if (isSelect) {
                        if (diff <= Lizzie.config.winLossThreshold5 || scoreDiff <= Lizzie.config.scoreLossThreshold5)
                            setBackground(new Color(85, 25, 80, 120));
                        else if (diff <= Lizzie.config.winLossThreshold4 || scoreDiff <= Lizzie.config.scoreLossThreshold4)
                            setBackground(new Color(208, 16, 19, 100));
                        else if (diff <= Lizzie.config.winLossThreshold3 || scoreDiff <= Lizzie.config.scoreLossThreshold3)
                            setBackground(new Color(200, 140, 50, 100));
                        else if (diff <= Lizzie.config.winLossThreshold2 || scoreDiff <= Lizzie.config.scoreLossThreshold2)
                            setBackground(new Color(180, 180, 0, 100));
                        else if (diff <= Lizzie.config.winLossThreshold1 || scoreDiff <= Lizzie.config.scoreLossThreshold1)
    ...
    public void saveTempGame(int index, String name) {
        ...
        data.get(index - 1).moves = Lizzie.board.moveListToString(Lizzie.board.getmovelistForSaveLoad());
        saveTempGame(data);
        File file = new File("save" + File.separator + "game" + index + ".bmp");
        try {
    ...
    public void saveAutoGame(int index) {
        ...
        Lizzie.config.saveBoardConfig.put("save-auto-game-move-number" + index, Lizzie.board.getCurrentMovenumber());
        Lizzie.config.saveBoardConfig.put("save-auto-game-move-list" + index, Lizzie.board.moveListToString(Lizzie.board.getmovelistForSaveLoad()));
    ...
    public void addTempGameOne(int index, int x, int y, String name, String time, boolean isAutoSave, int moveNumber, String moveList, boolean oriShowListPane, boolean OriShowVariationGraph) {
        JLabel boardImage = new JLabel();
        File file = new File((isAutoSave ? "save" + File.separator + "autoGame" : "save" + File.separator + "game") + index + ".bmp");
        try {
        ...
        JLabel lblIndex = new JLabel(isAutoSave ? Lizzie.resourceBundle.getString("LizzieFrame.saveAndLoad.autoRec") : Lizzie.resourceBundle.getString("LizzieFrame.saveAndLoad.rec") + index);
        ...
        btnLoad.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                loadFile(new File((isAutoSave ? "save" + File.separator + "autoGame" : "save" + File.separator + "game") + index + ".sgf"), true, true);
        ...
        btnSave.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                int ret = JOptionPane.showConfirmDialog(Lizzie.frame, Lizzie.resourceBundle.getString("LizzieFrame.recordExists"), Lizzie.resourceBundle.getString("LizzieFrame.warning"), JOptionPane.YES_NO_OPTION);
        ...
        JButton btnRename = new JButton(Lizzie.resourceBundle.getString("LizzieFrame.saveAndLoad.reName"));
    ...
    public void addTempGameNew(int index, int x, int y, boolean oriShowListPane, boolean OriShowVariationGraph) {
        JButton boardImage = new JButton(Lizzie.resourceBundle.getString("LizzieFrame.saveAndLoad.newRecord"));
        boardImage.setFont(new Font("SansSerif", Font.TRUETYPE_FONT, 15));
        boardImage.setBounds(x, y, 300, 300);
        JLabel lblIndex = new JLabel(Lizzie.resourceBundle.getString("LizzieFrame.saveAndLoad.rec") + index);
        lblIndex.setForeground(Color.WHITE);
        lblIndex.setBounds(x + 5, y + 300, 65, 20);
        JTextField txtName = new JTextField();
        txtName.setForeground(Color.WHITE);
        ...
        JButton btnSave = new JButton(Lizzie.resourceBundle.getString("LizzieFrame.saveAndLoad.newRecord"));
        btnSave.setMargin(new Insets(0, 0, 0, 0));
        ...
        btnSave.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                // TBD未完成
                addTempGame(index, txtName.getText().length() > 0 ? txtName.getText() : Lizzie.board.getHistory().getGameInfo().getSaveFileName());
                Lizzie.config.showListPane = oriShowListPane;
                Lizzie.config.showVariationGraph = OriShowVariationGraph;
                showTempGamePanel();
            }
        });
        boardImage.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                // TBD未完成
                addTempGame(index, txtName.getText().length() > 0 ? txtName.getText() : Lizzie.board.getHistory().getGameInfo().getSaveFileName());
    ...
    public ArrayList<TempGameData> getSaveGameList() {
        ...
        Optional<JSONArray> saveIndex = Optional.ofNullable(Lizzie.config.saveBoardConfig.optJSONArray("save-game-index"));
        Optional<JSONArray> saveName = Optional.ofNullable(Lizzie.config.saveBoardConfig.optJSONArray("save-game-name"));
        Optional<JSONArray> saveTime = Optional.ofNullable(Lizzie.config.saveBoardConfig.optJSONArray("save-game-time"));
        Optional<JSONArray> saveMoveNumber = Optional.ofNullable(Lizzie.config.saveBoardConfig.optJSONArray("save-game-move-number"));
        Optional<JSONArray> saveMoveList = Optional.ofNullable(Lizzie.config.saveBoardConfig.optJSONArray("save-game-move-list"));
    ...
    public void showTempGamePanel() {
        ...
        int width = Lizzie.frame.getWidth() - Lizzie.frame.getInsets().left - Lizzie.frame.getInsets().right - 12;
        tempGamePanelAll.setBounds(0, Lizzie.config.showDoubleMenu ? topPanelHeight : 0, Lizzie.frame.getWidth() - Lizzie.frame.getInsets().left - Lizzie.frame.getInsets().right, Lizzie.frame.getHeight() - Lizzie.frame.getJMenuBar().getHeight() - Lizzie.frame.getInsets().top - Lizzie.frame.getInsets().bottom - toolbarHeight - (Lizzie.config.showDoubleMenu ? topPanelHeight : 0));

        tempGamePanelTop.setBounds(0, 0, Lizzie.frame.getWidth() - Lizzie.frame.getInsets().left - Lizzie.frame.getInsets().right, 20);

        tempGameScrollPanel.setBounds(0, 0, Lizzie.frame.getWidth() - Lizzie.frame.getInsets().left - Lizzie.frame.getInsets().right, Lizzie.frame.getHeight() - Lizzie.frame.getJMenuBar().getHeight() - Lizzie.frame.getInsets().top - Lizzie.frame.getInsets().bottom - toolbarHeight - (Lizzie.config.showDoubleMenu ? topPanelHeight : 0));
        tempGamePanelAll.setVisible(true);
        tempGameScrollPanel.setVisible(true);
        tempGamePanel.setLayout(null);

        JCheckBox chkZoomImage = new JCheckBox(Lizzie.resourceBundle.getString("LizzieFrame.saveAndLoad.chkZoomImage")); // ("打开时自动恢复");
        JCheckBox chkAutoResume = new JCheckBox(Lizzie.resourceBundle.getString("LizzieFrame.saveAndLoad.chkAutoResume")); // ("打开时自动恢复");
        JCheckBox chkAutoSaveOnExit = new JCheckBox(Lizzie.resourceBundle.getString("LizzieFrame.saveAndLoad.chkAutoSaveOnExit")); // ("退出时自动存档");
        JButton btnDeleteAll = new JButton(Lizzie.resourceBundle.getString("LizzieFrame.saveAndLoad.btnDeleteAll")); // 全部删除
        btnDeleteAll.setMargin(new Insets(0, 0, 0, 0));
        JButton btnClose = new JButton(Lizzie.resourceBundle.getString("LizzieFrame.saveAndLoad.close")); // ("关闭");

        chkAutoSaveOnExit.setSelected(Lizzie.config.autoSaveOnExit);
        chkAutoSaveOnExit.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
        ...
        chkAutoResume.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
        ...
        btnDeleteAll.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                SwingUtilities.invokeLater(new Runnable() {
                    public void run() {
                        int ret = JOptionPane.showConfirmDialog(Lizzie.frame, Lizzie.resourceBundle.getString("LizzieFrame.saveAndLoad.deleteAllWarining"), Lizzie.resourceBundle.getString("LizzieFrame.warning"), JOptionPane.OK_CANCEL_OPTION);
                        if (ret == JOptionPane.CANCEL_OPTION || ret == -1) {
                            return;
                        }
                        deleteAllTempGame();
        ...
        chkZoomImage.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
        ...
        for (int i = 0; i < tempGameList.size(); i++) {
            ...
            data.x = x;
            data.y = y;
            addTempGameOne(data.index, x, y, data.name, data.time, data.isAutoSave, data.curMoveNumer, data.moves, oriShowListPane, OriShowVariationGraph);
        ...
        tempGamePanelLis = new MouseAdapter() {
            public void mouseMoved(MouseEvent e) {
                ...
                for (TempGameData data : tempGameList) {
                    if (data.x < x && (data.x + 300) > x) if (data.y < y && (data.y + 300) > y) {
                        isMouseOnImage = true;
                            ...
                            Runnable runnable2 = new Runnable() {
                                public void run() {
                                    ...
                                    if (e.getX() == bigBoardLastX && e.getY() == bigBoardLastY) {
                                        showBigBoardImage(data.isAutoSave, data.index, tempGamePanel, x, y, data.curMoveNumer, data.moves, oriShowListPane, OriShowVariationGraph);
                                    }
                                }
                            };
        ...
        tempGamePanelMoveLis = new MouseAdapter() {
            public void mouseClicked(MouseEvent e) {
                int x = e.getX();
                int y = e.getY();
                for (TempGameData data : tempGameList) {
                    if (data.x < x && (data.x + 300) > x) if (data.y < y && (data.y + 300) > y) {
                        canShowBigBoardImage = false;
                        loadFile(new File((data.isAutoSave ? "save" + File.separator + "autoGame" : "save" + File.separator + "game") + data.index + ".sgf"), true, true);
    ...
    private void showBigBoardImage(boolean isAutoSave, int index, JPanel panel, int x, int y, int moveNumber, String moveList, boolean oriShowListPane, boolean OriShowVariationGraph) {
        ...
        bigBoardPanelLis = new MouseAdapter() {
            public void mouseClicked(MouseEvent e) {
    ...
    public void countDownForHuman(int minuts, int seconds, int times) {
        ...
        timeScheduled.scheduleAtFixedRate(new Runnable() {
            int leftSeconds = 0;
            ...
            @Override
            public void run() {
                if (Lizzie.board.getHistory().isEmptyBoard() && Lizzie.board.getHistory().getGameInfo().getHandicap() > 0)
                    return;
                ...
                if (shouldStop) {
                    stopTimer();
                    if (playerIsBlack)
                        Lizzie.board.getHistory().getGameInfo().setResult(Lizzie.resourceBundle.getString("Byoyomi.timeOutBlack")); // ("白胜,黑超时");
                    else
                        Lizzie.board.getHistory().getGameInfo().setResult(Lizzie.resourceBundle.getString("Byoyomi.timeOutWhite")); // ("黑胜,白超时");
    ...
    public void flashAutoAnaSaveAndLoad() {
        ...
        String filename = path + File.separator + fileOtherName + "_" + Lizzie.resourceBundle.getString("Leelaz.analyzed") + "_" + df + ".sgf";
    ...
    public void flashAnalyzeGame(boolean isAllGame) {
        ...
        if (analysisEngine == null || analysisEngine.useJavaSSH && analysisEngine.javaSSHClosed || (!analysisEngine.useJavaSSH && (analysisEngine.process == null || !analysisEngine.process.isAlive()))) {
            try {
                analysisEngine = new AnalysisEngine(false);
                analysisEngine.sendRequest(isAllGame ? -1 : Lizzie.config.analysisStartMove, isAllGame ? -1 : Lizzie.config.analysisEndMove);
            } catch (IOException e) {
                // TODO Auto-generated catch block
                e.printStackTrace();
            }
    ...
    public static void redo(int movesToAdvance) {
        ...
        if (Lizzie.config.isDoubleEngineMode() && LizzieFrame.boardRenderer2.incrementDisplayedBranchLength(movesToAdvance)) {
            Lizzie.frame.refresh();
            return;
        }
        if (Lizzie.frame.independentMainBoard != null) {
            if (Lizzie.frame.independentMainBoard.boardRenderer.incrementDisplayedBranchLength(movesToAdvance)) {
                Lizzie.frame.refresh();
                return;
            }
        }
    ...
    public static void openSuggestionInfoCustom(Window owner) {
        // TODO Auto-generated method stub
        SuggestionInfoOrderSettings suggestionInfoOrderSettings = new SuggestionInfoOrderSettings(owner);
    ...
    public void clearMouseOverCoordinate(boolean isIndependBoard) {
        // TODO Auto-generated method stub
        if (isIndependBoard) {
            if (independentMainBoard != null) independentMainBoard.mouseOverCoordinate = outOfBoundCoordinate;
        } else {
            mouseOverCoordinate = outOfBoundCoordinate;
        }
    }
    ...
    class BlunderTableCellRenderer extends DefaultTableCellRenderer {
        public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
            ...
            try {
                double diffWinrate = Float.parseFloat(table.getValueAt(row, 2).toString().substring(0, table.getValueAt(row, 2).toString().length() - 1));
                if (Lizzie.board.isKataBoard || Lizzie.leelaz.isKatago) {
                    double scoreDiff = Float.parseFloat(table.getValueAt(row, 3).toString().substring(0, table.getValueAt(row, 3).toString().length() - 1));
                    if (column == 3) {
                        if (scoreDiff >= 1.5) setForeground(new Color(0, 170, 170));
                        else if (scoreDiff <= Lizzie.config.scoreLossThreshold5) setForeground(new Color(165, 25, 160));
                        else if (scoreDiff <= Lizzie.config.scoreLossThreshold4) setForeground(new Color(175, 16, 19));
                        else if (scoreDiff <= Lizzie.config.scoreLossThreshold3) setForeground(new Color(105, 162, 34));
                        else if (scoreDiff <= Lizzie.config.scoreLossThreshold2) setForeground(new Color(150, 150, 0));
                        else if (scoreDiff <= Lizzie.config.scoreLossThreshold1) setForeground(new Color(180, 120, 45));
                        else setForeground(new Color(0, 150, 0));
                    } else if (column == 2) {
                        if (diffWinrate >= 3) setForeground(new Color(0, 170, 170));
                        else if (diffWinrate <= Lizzie.config.winLossThreshold5) setForeground(new Color(165, 25, 160));
                        else if (diffWinrate <= Lizzie.config.winLossThreshold4) setForeground(new Color(175, 16, 19));
                        else if (diffWinrate <= Lizzie.config.winLossThreshold3) setForeground(new Color(105, 162, 34));
                        else if (diffWinrate <= Lizzie.config.winLossThreshold2) setForeground(new Color(150, 150, 0));
                        else if (diffWinrate <= Lizzie.config.winLossThreshold1) setForeground(new Color(180, 120, 45));
                        else setForeground(new Color(0, 150, 0));
    ...
    public void showAnalyzeGenmoveInfo() {
        ...
        lizzieCacheDiscribe.setInfoWide(Lizzie.resourceBundle.getString("LizzieFrame.aboutAnalyzeGenmoveInfo"), Lizzie.resourceBundle.getString("LizzieFrame.aboutAnalyzeGenmoveInfoTitle"), this);
    }
    ...
    public void clearScore() {
        ...
        if (Lizzie.board.boardGroupInfo != null && Lizzie.board.boardGroupInfo.scoreResult != null && Lizzie.board.boardGroupInfo.scoreResult.isVisible())
    ...
    public void reRenderTree() {
        if (shouldShowSimpleVariation()) return;
        Lizzie.frame.renderVarTree(Lizzie.frame.varTreeScrollPane.getWidth(), Lizzie.frame.varTreeScrollPane.getHeight(), true, false);
    }
    ...
    public void clearWRNforGame(boolean isGenmove) {
        ...
        if (isGenmove) {
            ...
            if ((EngineManager.isPreEngineGame || EngineManager.isEngineGame || isAnaPlayingAgainstLeelaz) && Lizzie.config.disableWRNInGame) {
                ...
                if (isAnaPlayingAgainstLeelaz) {
                    ...
                    {
                        if (Lizzie.engineManager.engineList.get(EngineManager.engineGameInfo.firstEngineIndex).isKatago) {
                            Lizzie.engineManager.engineList.get(EngineManager.engineGameInfo.firstEngineIndex).sendCommand("kata-set-param analysisWideRootNoise 0");
                            Lizzie.engineManager.engineList.get(EngineManager.engineGameInfo.firstEngineIndex).wrn = 0;
                        }
                        if (Lizzie.engineManager.engineList.get(EngineManager.engineGameInfo.secondEngineIndex).isKatago) {
                            Lizzie.engineManager.engineList.get(EngineManager.engineGameInfo.secondEngineIndex).sendCommand("kata-set-param analysisWideRootNoise 0");
                            Lizzie.engineManager.engineList.get(EngineManager.engineGameInfo.secondEngineIndex).wrn = 0;
                        }
                    }
                }
            }
    ...
    public String getPlayerName(boolean isBlack, int length) {
        // TODO Auto-generated method stub
        String player = isBlack ? Lizzie.board.getHistory().getGameInfo().getPlayerBlack() : Lizzie.board.getHistory().getGameInfo().getPlayerWhite();
        if (player.length() > length) player = player.substring(0, 11);
        if (player.equals(""))
            player = isBlack ? Lizzie.resourceBundle.getString("SGFParse.black") : Lizzie.resourceBundle.getString("SGFParse.white");
        return player;
    }
    ...
    public void toggleShowCandidates() {
        ...
        if (Lizzie.config.showBlackCandidates || Lizzie.config.showWhiteCandidates) {
            ...
            menu.setChkShowWhite(false);
            boardRenderer.clearAfterMove();
            if (Lizzie.config.isDoubleEngineMode() && boardRenderer2 != null) boardRenderer2.clearAfterMove();
        } else {
            toolbar.setChkShowBlack(Lizzie.config.showBlackCandidatesHistroy);
            toolbar.setChkShowWhite(Lizzie.config.showWhiteCandidatesHistroy);
            menu.setChkShowBlack(Lizzie.config.showBlackCandidatesHistroy);
            menu.setChkShowWhite(Lizzie.config.showWhiteCandidatesHistroy);
        }
    }
    ...
    private void openInVisibleFrame() {
        ...
        try {
            if (OS.isWindows()) {
                ...
                if (java64.exists()) {
                    try {
                        processClockHelper = Runtime.getRuntime().exec(java64Path + " -jar clockHelper" + File.separator + javaReadBoardName);
                        success = true;
                    } catch (Exception e) {
                        success = false;
                        e.printStackTrace();
                ...
                if (!success) {
                    ...
                    if (java32.exists()) {
                        try {
                            processClockHelper = Runtime.getRuntime().exec(java32 + " -jar clockHelper" + File.separator + javaReadBoardName);
                            success = true;
                        } catch (Exception e) {
                            success = false;
                            e.printStackTrace();
                ...
                if (!success) {
                    processClockHelper = Runtime.getRuntime().exec("java -jar clockHelper" + File.separator + javaReadBoardName);
                }
            } else {
                processClockHelper = Runtime.getRuntime().exec("java -jar clockHelper" + File.separator + javaReadBoardName);
            }
