...
public class BottomToolbar extends JPanel {
    ...
    public BottomToolbar() {
        Color hsbColor = Color.getHSBColor(Color.RGBtoHSB(232, 232, 232, null)[0], Color.RGBtoHSB(232, 232, 232, null)[1], Color.RGBtoHSB(232, 232, 232, null)[2]);
        ...
        deleteMove = new JFontButton(Lizzie.resourceBundle.getString("BottomToolbar.deleteMove")); // ("删除");
        badMoves = new JFontButton(Lizzie.resourceBundle.getString("BottomToolbar.badMoves")); // ("超级鹰眼");
        ...
        liveButton = new JFontButton(Lizzie.resourceBundle.getString("BottomToolbar.liveButton")); // ("直播");
        clearButton = new JFontButton(Lizzie.resourceBundle.getString("BottomToolbar.clearButton")); // ("清空棋盘");
        firstButton = new JFontButton("|<");
        lastButton = new JFontButton(">|");
        countButton = new JFontButton(Lizzie.resourceBundle.getString("BottomToolbar.countButton")); // ("形势判断");
        finalScore = new JFontButton(Lizzie.resourceBundle.getString("BottomToolbar.finalScore")); // ("终局数子");
        forward10 = new JFontButton(">>");
        backward10 = new JFontButton("<<");
        gotomove = new JFontButton(Lizzie.resourceBundle.getString("BottomToolbar.gotomove")); // ("跳转");
        savefile = new JFontButton(Lizzie.resourceBundle.getString("BottomToolbar.savefile")); // ("保存");
        backward1 = new JFontButton("<");
        forward1 = new JFontButton(">");
        openfile = new JFontButton(Lizzie.resourceBundle.getString("BottomToolbar.openfile")); // ("打开");
        kataEstimate = new JFontButton(Lizzie.resourceBundle.getString("BottomToolbar.kataEstimate")); // ("Kata评估");
        ...
        backMain = new JFontButton(Lizzie.resourceBundle.getString("BottomToolbar.backMain")); // ("返回主分支");
        setMain = new JFontButton(Lizzie.resourceBundle.getString("BottomToolbar.setMain")); // ("设为主分支");
        batchOpen = new JFontButton(Lizzie.resourceBundle.getString("BottomToolbar.batchOpen")); // ("批量分析");
        ...
        analyzeList = new JFontButton(Lizzie.resourceBundle.getString("BottomToolbar.analyzeList")); // ("选点列表");
        ...
        autoPlay = new JFontButton(Lizzie.resourceBundle.getString("BottomToolbar.autoPlay")); // ("自动播放");
        ...
        txtMoveNumber.addKeyListener(new KeyListener() {
            @Override
        ...
        moveRank.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
        ...
        final JFontMenuItem flashAnalyzeAllGame = new JFontMenuItem(resourceBundle.getString("Menu.flashAnalyzeAllGame"));
        flashAnalyzePopup.add(flashAnalyzeAllGame);
        flashAnalyzeAllGame.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                Lizzie.frame.flashAnalyzeGame(true);
            }
        });

        final JFontMenuItem flashAnalyzePartGame = new JFontMenuItem(resourceBundle.getString("Menu.flashAnalyzePartGame"));
        flashAnalyzePopup.add(flashAnalyzePartGame);
        flashAnalyzePartGame.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                Lizzie.frame.flashAnalyzePart();
            }
        });
        final JFontMenuItem flashAnalyzeSettings = new JFontMenuItem(resourceBundle.getString("Menu.flashAnalyzeSettings"));
        flashAnalyzePopup.add(flashAnalyzeSettings);
        flashAnalyzeSettings.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
        ...
        flashAnalyze.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                flashAnalyzePopup.show(buttonPane, flashAnalyze.getX(), flashAnalyze.getY() - flashAnalyzePopup.getHeight());
            }
        });

        sharePopup = new JPopupMenu();
        JFontMenuItem shareCurSgf = new JFontMenuItem(Lizzie.resourceBundle.getString("BottomToolbar.shareCurSgf")); // ("分享当前棋谱");
        shareCurSgf.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                Lizzie.frame.shareSGF();
            }
        });

        JFontMenuItem shareBatchSgf = new JFontMenuItem(Lizzie.resourceBundle.getString("BottomToolbar.shareBatchSgf")); // ("分享当前棋谱");
        shareBatchSgf.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
        ...
        JFontMenuItem editHistoryRemote = new JFontMenuItem(Lizzie.resourceBundle.getString("BottomToolbar.editHistoryRemote")); // ("查询(修改)已分享棋谱信息");
        editHistoryRemote.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                Lizzie.frame.openPrivateKifuSearch();
            }
        });

        JFontMenuItem shareHistoryRemote = new JFontMenuItem(Lizzie.resourceBundle.getString("BottomToolbar.shareHistoryRemote")); // ("公开棋谱查询");
        shareHistoryRemote.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
        ...
        yike = new JPopupMenu();
        JFontMenuItem yikeLive = new JFontMenuItem(Lizzie.resourceBundle.getString("BottomToolbar.yikeLive")); // ("弈客直播");
        yikeLive.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                Lizzie.frame.bowser("https://home.yikeweiqi.com/#/live", (Lizzie.resourceBundle.getString("BottomToolbar.yikeLive")), true);
            }
        });
        yike.add(yikeLive);

        JFontMenuItem yikeRoom = new JFontMenuItem(Lizzie.resourceBundle.getString("BottomToolbar.yikeRoom")); // ("弈客大厅");
        yikeRoom.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                Lizzie.frame.bowser("https://home.yikeweiqi.com/#/game", (Lizzie.resourceBundle.getString("BottomToolbar.yikeRoom")), true);
            }
        });
        yike.add(yikeRoom);

        JFontMenuItem foxKifu = new JFontMenuItem(Lizzie.resourceBundle.getString("Menu.foxKifu")); // ("野狐");
        foxKifu.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
        ...
        JFontMenuItem syncBoardJava = new JFontMenuItem(Lizzie.resourceBundle.getString("BottomToolbar.syncBoardJava")); // ("棋盘同步");
        syncBoardJava.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
        ...
        JFontMenuItem syncBoard = new JFontMenuItem(Lizzie.resourceBundle.getString("BottomToolbar.syncBoard")); // ("棋盘同步");
        syncBoard.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
        ...
        badMoves.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                Lizzie.frame.toggleBadMoves();
            }
        });

        tryPlay.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                Lizzie.frame.tryPlay(true);
            }
        });
        analyzeList.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
        ...
        final JFontMenuItem autoAnalyze = new JFontMenuItem(resourceBundle.getString("Menu.autoAnalyze")); // ("自动分析(A)");
        // aboutItem.setMnemonic('A');
        autoAnalyze.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
        ...
        final JFontMenuItem batchAnalyze = new JFontMenuItem(resourceBundle.getString("Menu.batchAnalyze")); // ("批量分析(Ctrl+O)");
        batchAnalyze.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
        ...
        final JFontMenuItem batchAnalysisMode = new JFontMenuItem(resourceBundle.getString("Menu.batchAnalysisMode")); // ("批量分析(闪电模式)");
        batchAnalysisMode.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
        ...
        final JFontMenuItem stopAutoAnalyze = new JFontMenuItem(resourceBundle.getString("Menu.stopAutoAnalyze")); // ("停止自动(批量)分析");
        autoAnalyzePopup.add(stopAutoAnalyze);
        stopAutoAnalyze.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                LizzieFrame.toolbar.stopAutoAna(true, true);
            }
        });

        final JFontMenuItem batchAnalyzeTable = new JFontMenuItem(resourceBundle.getString("Menu.batchAnalyzeTable")); // ("批量分析进度表");
        autoAnalyzePopup.add(batchAnalyzeTable);
        batchAnalyzeTable.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
        ...
        batchOpen.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                autoAnalyzePopup.show(buttonPane, batchOpen.getX(), batchOpen.getY() - autoAnalyzePopup.getHeight());
            }
        });
        ...
        backward1.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
//                上一手点击@dongxiaoming
                if (EngineManager.isEngineGame) {
                    return;
        ...
        gotomove.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                if (EngineManager.isEngineGame) return;
                checkMove();
                if (Lizzie.frame.commentEditPane.isVisible()) Lizzie.frame.setCommentEditable(false);
        ...
        kataEstimate.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
        ...
        chkAutoAnalyse.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
        ...
        chkAnaBlack.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                // TBD
                setTxtUnfocuse();
        ...
        chkAnaWhite.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                // TBD
                setTxtUnfocuse();
        ...
        txtFirstAnaMove.addFocusListener(new FocusListener() {
            @Override
        ...
        txtLastAnaMove.addFocusListener(new FocusListener() {
            @Override
            public void focusLost(FocusEvent e) {
                // 失去焦点执行的代码
                try {
        ...
        chkAnaFirstPlayouts.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                // TBD
                setTxtUnfocuse();
        ...
        chkAnaAutoSave.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                // TBD
                setTxtUnfocuse();
        ...
        chkAnaPlayouts.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                // TBD
                setTxtUnfocuse();
        ...
        chkAnaTime.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                // TBD
                setTxtUnfocuse();
        ...
        analysisTable.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                Lizzie.frame.openAnalysisTable();
            }
        });
        ...
        chkShowBlack.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                // TBD
                setTxtUnfocuse();
        ...
        chkShowWhite.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                // TBD
                setTxtUnfocuse();
        ...
        chkAutoMain.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                autoPlayMain(false);
                setTxtUnfocuse();
        ...
        chkAutoSub.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                // TBD
                // autoPlaySub();
        ...
        chkAutoPlayBlack.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                // TBD
                setTxtUnfocuse();
        ...
        chkAutoPlayWhite.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                // TBD
                setTxtUnfocuse();
        ...
        chkAutoPlayTime.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                // TBD
                setTxtUnfocuse();
        ...
        chkAutoPlayPlayouts.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                // TBD
                setTxtUnfocuse();
        ...
        chkAutoPlayFirstPlayouts.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                // TBD
                setTxtUnfocuse();
        ...
        chkenginePk.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                // TBD未完成
                setTxtUnfocuse();
        ...
        btnEnginePkConfig.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                // TBD未完成
                setTxtUnfocuse();
        ...
        btnEnginePkStop.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                // TBD未完成
                setTxtUnfocuse();
                if (isGenmoveToolbar) {
                    if (isPkStop) {
                        if (!isPkGenmoveStop) {
                            Utils.showMsg(Lizzie.resourceBundle.getString("BottomToolbar.genmoveStopHint")); // (BottomToolbar.genmoveStopHint);
                            //                  Message msg = new Message();
                        ...
                        isPkStop = false;
                        if (isPkStopGenmoveB) {
                            Lizzie.engineManager.engineList.get(EngineManager.engineGameInfo.blackEngineIndex).nameCmd();
                            Lizzie.engineManager.engineList.get(EngineManager.engineGameInfo.blackEngineIndex).genmoveForPk("B");
                            if (Lizzie.config.enginePkPonder)
                                Lizzie.engineManager.engineList.get(EngineManager.engineGameInfo.whiteEngineIndex).ponder();
                        } else {
                            Lizzie.engineManager.engineList.get(EngineManager.engineGameInfo.whiteEngineIndex).nameCmd();
                            Lizzie.engineManager.engineList.get(EngineManager.engineGameInfo.whiteEngineIndex).genmoveForPk("W");
                            if (Lizzie.config.enginePkPonder)
                                Lizzie.engineManager.engineList.get(EngineManager.engineGameInfo.blackEngineIndex).ponder();
                        }
        ...
        chkenginePkTime.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                setTxtUnfocuse();
        ...
        btnStartPk.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                //            Lizzie.frame.removeInput();
                //            // TBD未完成
        ...
        chkenginePkFirstPlayputs.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                setTxtUnfocuse();
        ...
        dt.addDocumentListener(new DocumentListener() {
            public void insertUpdate(DocumentEvent e) {
                if (EngineManager.isEngineGame || EngineManager.isPreEngineGame) {
                    EngineManager.engineGameInfo.batchNumber = Utils.parseTextToInt(txtenginePkBatch, EngineManager.engineGameInfo.batchNumber);
                }
            }
        ...
        chkenginePkBatch.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                setTxtUnfocuse();
        ...
        chkenginePkContinue.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                setTxtUnfocuse();
            }
        ...
        chkenginePkPlayouts.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                setTxtUnfocuse();
        ...
        btnEngineMannul.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                // 打开干预面板
        ...
        if (persisted && Lizzie.config.persistedUi.optJSONArray("toolbar-parameter") != null && Lizzie.config.persistedUi.optJSONArray("toolbar-parameter").length() == 51) {
    ...
    private void setButtonSize(JButton button, boolean widden) {
        button.setSize(button.getFontMetrics(button.getFont()).stringWidth(button.getText()) + (widden ? 14 : 12), 26);
    }
    ...
    public void getAllDiffNodesAfter(BoardHistoryNode node, ArrayList<BoardHistoryNode> diffList) {
        // 待完成
        if (!node.getData().blackToPlay && Lizzie.config.autoAnaDiffBlack || node.getData().blackToPlay && Lizzie.config.autoAnaDiffWhite) {
            if (node.analyzed) {
                if (Lizzie.config.autoAnaDiffUseWin && Math.abs(Lizzie.board.lastWinrateDiff(node)) >= Lizzie.config.autoAnaDiffWinThreshold) {
                    diffList.add(node.previous().get());
                    diffList.add(node);
                } else if (Lizzie.config.autoAnaDiffUseScore && Math.abs(Lizzie.board.lastScoreMeanDiff(node)) >= Lizzie.config.autoAnaDiffScoreThreshold) {
                    diffList.add(node.previous().get());
                    diffList.add(node);
                }
            }
    ...
    private ArrayList<BoardHistoryNode> getDiffNodes() {
        ...
        if (Lizzie.config.analyzeAllBranch) {
            ...
            while (node.next().isPresent() && (Lizzie.config.autoAnaEndMove == -1 || node.next().get().getData().moveNumber <= Lizzie.config.autoAnaEndMove)) {
                if (!node.getData().blackToPlay && Lizzie.config.autoAnaDiffBlack || node.getData().blackToPlay && Lizzie.config.autoAnaDiffWhite) {
                    if (node.analyzed) {
                        if (Lizzie.config.autoAnaDiffUseWin && Math.abs(Lizzie.board.lastWinrateDiff(node)) >= Lizzie.config.autoAnaDiffWinThreshold) {
                            diffList.add(node.previous().get());
    ...
    private boolean checkDiffAnalyze(boolean isForceStop) {
        ...
        if (Lizzie.config.analyzeAllBranch) if (threadAnalyzeAllNode != null) threadAnalyzeAllNode.interrupt();
        ...
        if (!isForceStop) {
            ...
            Utils.showMsgNoModalForTime(resourceBundle.getString("BottomToolbar.noticeBigDiff") + diffMoves + "(" + resourceBundle.getString("BottomToolbar.needAnalyze") + needAnalyzeMoves + ")" + resourceBundle.getString("BottomToolbar.startReAnalyze"), 3);
            return true;
        } else {
            ...
            int ret = JOptionPane.showConfirmDialog(Lizzie.frame, resourceBundle.getString("BottomToolbar.noticeBigDiff") + diffMoves + "(" + resourceBundle.getString("BottomToolbar.needAnalyze") + needAnalyzeMoves + ")" + resourceBundle.getString("BottomToolbar.askStartReAnalyze"), resourceBundle.getString("BottomToolbar.askStartReAnalyzeTitle"), JOptionPane.OK_CANCEL_OPTION);
    ...
    public void stopAutoAna(boolean needCheckDiff, boolean isForceStop) {
        ...
        if (Lizzie.frame.isBatchAna || LizzieFrame.toolbar.chkAnaAutoSave.isSelected()) {
            ...
            if (Lizzie.config.analyzeAllBranch) if (threadAnalyzeAllNode != null) threadAnalyzeAllNode.interrupt();
            Utils.showMsgNoModal(Lizzie.resourceBundle.getString("BottomToolbar.stopAutoAnaHint")); // (BottomToolbar.stopAutoAnaHint);
            //      if (msg == null || !msg.isVisible()) {
            //        msg = new Message();
    ...
    private void autoAnaSaveAndLoad() {
        ...
        if (!Lizzie.frame.isBatchAna) {
            ...
            if (LizzieFrame.curFile != null) {
                ...
                String filename = path + File.separator + fileOtherName + "_" + resourceBundle.getString("Leelaz.analyzed") + "_" + df + ".sgf";
                ...
                String df = new SimpleDateFormat("yyyyMMddHHmmss").format(new Date());
                File autoSaveFile = new File(courseFile + File.separator + "AnalyzedGames" + File.separator + df + ".sgf");
                ...
                if (msg == null || !msg.isVisible()) {
                    msg = new Message();
                    msg.setMessageNoModal(resourceBundle.getString("Leelaz.autoAnalyzeComplete") + courseFile + File.separator + "AnalyzedGames");
                }
            }
            if (Lizzie.config.analyzeAllBranch) if (threadAnalyzeAllNode != null) threadAnalyzeAllNode.interrupt();
            return;
    ...
    public void loadAutoBatchFile() {
        ...
        try {
            LizzieFrame.toolbar.firstMove = Integer.parseInt(LizzieFrame.toolbar.txtFirstAnaMove.getText());
        } catch (Exception ex) {
        }
        try {
    ...
    public void setOrder() {
        if ((anaPanelOrder != enginePkOrder) && (anaPanelOrder != autoPlayOrder) && (enginePkOrder != autoPlayOrder)) {
    ...
    public void setTxtUnfocuse() {
        if(Lizzie.leelaz.isPondering()){
            //上一步下一步如果打开了分析，要在棋盘上展示分析@dongxiaoming
            Lizzie.leelaz.ponder();
        }
    ...
    public void startAutoAna() {
        ...
        if (Lizzie.config.autoAnaStartMove >= 0) {
            if (Lizzie.config.autoAnaStartMove > 0) Lizzie.config.autoAnaStartMove = Lizzie.config.autoAnaStartMove - 1;
            Lizzie.board.goToMoveNumber(Lizzie.config.autoAnaStartMove);
        } else if (Lizzie.config.analyzeAllBranch && !Lizzie.board.getHistory().getCurrentHistoryNode().isMainTrunk()) {
            Lizzie.board.goToMoveNumber(0);
        }
        if (Lizzie.config.autoAnaDiffEnable) autoAnaStartNode = Lizzie.board.getHistory().getCurrentHistoryNode();
        ...
        if (Lizzie.frame.isBatchAna && Lizzie.frame.Batchfiles != null && Lizzie.frame.Batchfiles.size() > 1 && Lizzie.frame.BatchAnaNum == 0)
            Lizzie.frame.openAnalysisTable();
        start.setText("终止");
    ...
    public void addEngineLis() {
        enginePkBlackLis = new ItemListener() {
            public void itemStateChanged(final ItemEvent e) {
                engineBlackToolbar = enginePkBlack.getSelectedIndex();
                setTxtUnfocuse();
            }
        };
        enginePkWhiteLis = new ItemListener() {
            public void itemStateChanged(final ItemEvent e) {
    ...
    public boolean startEngineGame() {
        ...
        int timeBlack = -1, timeWhite = -1, playoutsBlack = -1, playoutsWhite = -1, firstPlayoutsBlack = -1, firstPlayoutsWhite = -1;
        if (chkenginePkTime.isSelected()) {
        ...
        return Lizzie.engineManager.startEngineGame(engineBlack, engineWhite, timeBlack, timeWhite, playoutsBlack, playoutsWhite, firstPlayoutsBlack, firstPlayoutsWhite, isBatchGame, batchGameNumber, batchGameName, isContinueGame, isGenmove, isExchange, checkGameMaxMove, maxGameMoves);
    }
                        ...
                        if (curNode == Lizzie.board.getHistory().getCurrentHistoryNode()) {
                            if (Lizzie.config.directlyWithBestMove) {
                                ...
                                if (Lizzie.config.continueWithBestMove) {
                                    ...
                                    if (!cur.getData().lastMove.isPresent() && cur.previous().isPresent() && !cur.previous().get().getData().lastMove.isPresent())
                                        break;
                                    Lizzie.frame.playBestMove();
                                } else {
                                    if (autoQuit) break;
                ...
                public void run() {
                    ...
                    while (chkAutoSub.isSelected()) {
                        if (!LizzieFrame.subBoardRenderer.wheeled)
                            LizzieFrame.subBoardRenderer.setDisplayedBranchLength(displayedSubBoardBranchLength);
                        if (Lizzie.config.isShowingIndependentSub)
                            if (!Lizzie.frame.independentSubBoard.subBoardRenderer.wheeled)
                                Lizzie.frame.independentSubBoard.subBoardRenderer.setDisplayedBranchLength(displayedSubBoardBranchLength);
                        ...
                        if (EngineManager.isEmpty || !Lizzie.leelaz.isLoaded() || !Lizzie.leelaz.isPondering())
                            Lizzie.frame.refresh();
                    }
                    isAutoPlaySub = false;
                }
    ...
    public void reSetButtonLocation() {
        ...
        if (length < w - (this.showDetail ? (Config.isScaled ? 34 : 33) : 16)) {
            ...
            setLocationLeft(0);
            if (showDetail)
                buttonPane.setBounds((Math.max(0, w - 16 - length - (Config.isScaled ? 20 : 19)) / 2) + (Config.isScaled ? 20 : 19), 0, length, 26);
            ...
            if (w < 15) {
                if (showDetail) buttonPane.setBounds(Config.isScaled ? 40 : 38, 0, Lizzie.frame.getWidth(), 26);
            ...
            if (w < x + (showDetail ? (Config.isScaled ? 34 : 33) : 16)) {
                if (showDetail)
                    buttonPane.setBounds((Config.isScaled ? 20 : 19), 0, this.getWidth() - (Config.isScaled ? 41 : 39), 26);
                else buttonPane.setBounds(0, 0, this.getWidth() - (Config.isScaled ? 20 : 19), 26);
                rightMove.setVisible(true);
                if (showDetail) rightMove.setBounds(this.getWidth() - (Config.isScaled ? 21 : 20), 0, 20, 26);
