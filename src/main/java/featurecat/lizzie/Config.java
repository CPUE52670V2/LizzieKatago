...
public class Config {
  ...
  //程序开始后不开启分析
  public boolean notStartPondering = true;
  ...
  public boolean showBlackCandidatesHistroy = true;
  public boolean showWhiteCandidatesHistroy = true;
  ...
  public void toggleShowWinrate() {
    ...
    if (extraMode == ExtraMode.Min && showWinrateGraph){
      toggleExtraMode(0);
    }
