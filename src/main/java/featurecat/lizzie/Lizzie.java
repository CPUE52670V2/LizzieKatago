...
public class Lizzie {
    ...
    public static String checkVersion = "220129";
    ...
    public static boolean isShowRecommend() {
        ...
        if (nexts.size() > 0) {
           boolean isBlack = nexts.get(0).getData().lastMoveColor == Stone.BLACK;
           if(isBlack&&Lizzie.config.showBlackCandidates){
               return true;
           }else if(!isBlack&&Lizzie.config.showBlackCandidates){
               return true;
           }
        }
