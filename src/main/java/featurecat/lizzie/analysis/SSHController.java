...
public class SSHController {
    ...
    public Boolean login(String command, String userName, String password) {
        ...
        try {
            ...
            try {
                this.owner.tryToDignostic(String.valueOf(Lizzie.resourceBundle.getString("SSHController.engineFailed")) + ": " + ((err == null) ? Lizzie.resourceBundle.getString("Leelaz.engineStartNoExceptionMessage") : err), true);
                LizzieFrame.openMoreEngineDialog();
